...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, i) {
      ...
      function n(t, e, i, o) {
        var n = !1;
        !0 === o && (n = null === e[i] && void 0 !== t[i]),
          n ? delete t[i] : (t[i] = e[i]);
      }
      var s = i(86),
        r = o(s),
        a = i(43),
      ...
      (e.isNumber = function (t) {
        ...
        (e.fillIfDefined = function (t, i) {
          ...
          for (var s in t)
            void 0 !== i[s] &&
              (null === i[s] || 'object' !== (0, p.default)(i[s])
                ? n(t, i, s, o)
                : 'object' === (0, p.default)(t[s]) &&
                  e.fillIfDefined(t[s], i[s], o));
        }),
        ...
        (e.selectiveDeepExtend = function (t, i, o) {
          ...
          for (var r = 0; r < t.length; r++) {
            ...
            if (o.hasOwnProperty(a))
              if (o[a] && o[a].constructor === Object)
                void 0 === i[a] && (i[a] = {}),
                  i[a].constructor === Object
                    ? e.deepExtend(i[a], o[a], !1, s)
                    : n(i, o, a, s);
              else {
        ...
        (e.selectiveNotDeepExtend = function (t, i, o) {
          ...
          for (var r in o)
            if (o.hasOwnProperty(r) && -1 === t.indexOf(r))
              if (o[r] && o[r].constructor === Object)
                void 0 === i[r] && (i[r] = {}),
                  i[r].constructor === Object
                    ? e.deepExtend(i[r], o[r])
                    : n(i, o, r, s);
              else if (Array.isArray(o[r])) {
                i[r] = [];
          ...
          if (void 0 !== t) {
            ...
            switch (i) {
              ...
              case 'Date':
                ...
                if (c.isMoment(t)) return new Date(t.valueOf());
                if (e.isString(t))
                  return (
                    (o = f.exec(t)),
                    o ? new Date(Number(o[1])) : c(new Date(t)).toDate()
                  );
                throw new Error(
              ...
              case 'Moment':
                if (e.isNumber(t)) return c(t);
                if (t instanceof Date) return c(t.valueOf());
                if (c.isMoment(t)) return c(t);
                if (e.isString(t))
                  return (o = f.exec(t)), c(o ? Number(o[1]) : t);
                throw new Error(
                  'Cannot convert object of type ' +
                    e.getType(t) +
                    ' to type Date'
              ...
              case 'ISODate':
                ...
                if (c.isMoment(t)) return t.toDate().toISOString();
                if (e.isString(t))
                  return (
                    (o = f.exec(t)),
                    o ? new Date(Number(o[1])).toISOString() : c(t).format()
                  );
                throw new Error(
                  'Cannot convert object of type ' +
                    e.getType(t) +
      ...
      (e.getType = function (t) {
        var e = void 0 === t ? 'undefined' : (0, p.default)(t);
        return 'object' == e
          ? null === t
            ? 'null'
      ...
      (e.addCssText = function (t, i) {
        ...
        (e.bridgeObject = function (t) {
          if (
            null !== t &&
            'object' === (void 0 === t ? 'undefined' : (0, p.default)(t))
          ) {
            var i = (0, h.default)(t);
        ...
        (e.mergeOptions = function (t, e, i) {
          ...
          var r = e[i],
            ...
            d = a ? o[i] : void 0,
            l = d ? d.enabled : void 0;
          if (void 0 !== r) {
            if ('boolean' == typeof r)
              return s(t[i]) || (t[i] = {}), void (t[i].enabled = r);
            if (null === r && !s(t[i])) {
              if (!n(d)) return;
              t[i] = (0, h.default)(d);
            }
        ...
        (e.getScrollBarWidth = function () {
          ...
          var o = t.offsetWidth;
          return (
            i == o && (o = e.clientWidth), document.body.removeChild(e), i - o
          );
        }),
      ...
      (n.prototype.setOptions = function (t) {
        ...
        (n.prototype.add = function (t, e) {
          ...
          if (Array.isArray(t))
            ...
            if (
              !t ||
              'object' !== (void 0 === t ? 'undefined' : (0, h.default)(t))
            )
        ...
        (n.prototype.get = function (t) {
          ...
          if (o && o.returnType) {
            r =
              -1 == ['Array', 'Object'].indexOf(o.returnType)
                ? 'Array'
                : o.returnType;
          } else r = 'Array';
          var a,
            ...
            f = o && o.filter,
            g = [];
          if (void 0 != e) (a = n._getItem(e, m)) && f && !f(a) && (a = null);
          else if (void 0 != i)
            for (p = 0, c = i.length; p < c; p++)
              (a = n._getItem(i[p], m)), (f && !f(a)) || g.push(a);
          else
            for (
              h = (0, l.default)(this._data), p = 0, c = h.length;
              p < c;
              p++
            )
              (d = h[p]), (a = n._getItem(d, m)), (f && !f(a)) || g.push(a);
          if (
            (o && o.order && void 0 == e && this._sort(g, o.order),
            o && o.fields)
          ) {
            var v = o.fields;
            if (void 0 != e) a = this._filterFields(a, v);
            else
              for (p = 0, c = g.length; p < c; p++)
                g[p] = this._filterFields(g[p], v);
          }
          if ('Object' == r) {
            var y,
              b = {};
            for (p = 0, c = g.length; p < c; p++) (y = g[p]), (b[y.id] = y);
            return b;
          }
          return void 0 != e ? a : g;
        }),
        ...
        (n.prototype.remove = function (t, e) {
          ...
          for (h = Array.isArray(t) ? t : [t], i = 0, o = h.length; i < o; i++)
            (s = this._remove(h[i])) &&
              void 0 != (n = s[this._fieldId]) &&
              (r.push(n), a.push(s));
          return (
            r.length && this._trigger('remove', { items: r, oldData: a }, e), r
          );
        }),
      ...
      var o = i(6),
        ...
        a = function (t, e, i) {
          var h,
            ...
            v = p ? n : n[e] || (n[e] = {}),
            y = v.prototype,
            b = p ? o : c ? o[e] : (o[e] || {}).prototype;
          p && (i = e);
          for (h in i)
            ((d = !u && b && void 0 !== b[h]) && h in v) ||
              ((l = d ? b[h] : i[h]),
              (v[h] =
      ...
      (o.prototype.setData = function (t) {
        ...
        (o.prototype.refresh = function () {
          ...
          for (e = 0, i = n.length; e < i; e++)
            (t = n[e]),
              r[t] ||
                (h.push(t), d.push(this._data._data[t]), delete this._ids[t]);
        ...
        (o.prototype._onEvent = function (t, e, i) {
          ...
          if (a && this._data) {
            switch (t) {
              case 'add':
                for (o = 0, n = a.length; o < n; o++)
                  (s = a[o]),
                    (r = this.get(s)) && ((this._ids[s] = !0), h.push(s));
                break;
              case 'update':
                for (o = 0, n = a.length; o < n; o++)
                  (s = a[o]),
            ...
            (this.length += h.length - l.length),
              ...
              d.length &&
                this._trigger('update', { items: d, oldData: u, data: p }, i),
              l.length && this._trigger('remove', { items: l, oldData: c }, i);
          }
        }),
        (o.prototype.on = a.prototype.on),
        (o.prototype.off = a.prototype.off),
        (o.prototype._trigger = a.prototype._trigger),
        (o.prototype.subscribe = o.prototype.on),
        (o.prototype.unsubscribe = o.prototype.off),
        (t.exports = o);
    },
    function (t, e, i) {
      (e.convertHiddenOptions = function (t, i, o) {
            ...
            for (
              ...
              if (void 0 !== o[h].repeat) {
                ...
                if ('Invalid Date' == d._d)
                  throw new Error(
                    'Supplied start date is not valid: ' + o[h].start
                  );
                if ('Invalid Date' == l._d)
                  throw new Error(
                    'Supplied end date is not valid: ' + o[h].end
                  );
                var u = l - d;
                if (u >= 4 * a) {
                  var p = 0,
        ...
        (e.toScreen = function (t, i, o) {
          ...
          if (0 == t.body.hiddenDates.length)
            return (
              (n = t.range.conversion(o)), (i.valueOf() - n.offset) * n.scale
            );
          ...
          if (i < t.range.start) {
            ...
            var a = e.getHiddenDurationBeforeStart(
              t.body.hiddenDates,
              i,
              n.offset
            );
          ...
          if (this.options.tooltipOnItemUpdateTime) {
            ...
            if (this.dom.onItemUpdateTimeTooltip) {
              ...
              this.options.tooltipOnItemUpdateTime.template
                ? ((r = this.options.tooltipOnItemUpdateTime.template.bind(
                    this
                  )),
                  (s = r(this.data)))
                : ((s =
                    'start: ' + u(this.data.start).format('MM/DD/YYYY hh:mm')),
                  this.data.end &&
                    (s +=
                      '<br> end: ' +
                      u(this.data.end).format('MM/DD/YYYY hh:mm'))),
                (this.dom.onItemUpdateTimeTooltip.innerHTML = s);
            }
          }
        }),
        (n.prototype._updateContents = function (t) {
          ...
          if (
            (this.options.visibleFrameTemplate
              ? ((n = this.options.visibleFrameTemplate.bind(this)),
                (o = n(s, r)))
              : (o = ''),
            a)
          )
          ...
          if (
            ...
            this._contentToString(this.content) !== this._contentToString(e)
          ) {
    ...
    function (t, e, i) {
      function o(t, e) {
        (this.dom = {
          ...
          (this.options = r.extend({}, this.defaultOptions)),
          (this.body = t),
          this._create(),
          this.setOptions(e);
      }
      ...
      (o.prototype = new a()),
        ...
        (o.prototype._repaintLabels = function () {
          ...
          s.setMoment(this.options.moment),
            ...
            (this.step = s);
          var a = this.dom;
          (a.redundant.lines = a.lines),
            (a.redundant.majorTexts = a.majorTexts),
            (a.redundant.minorTexts = a.minorTexts),
            (a.lines = []),
            (a.majorTexts = []),
            (a.minorTexts = []);
          var l,
            ...
            x = 0;
          for (
            s.start(), l = s.getCurrent(), c = this.body.util.toScreen(l);
            s.hasNext() && x < 1e3;
            ...
            if (this.options.showMinorLabels && f) {
              var D = this._repaintMinorText(p, y, t, b);
              D.style.width = _ + 'px';
            }
            m && this.options.showMajorLabels
              ? (p > 0 &&
                  (void 0 == w && (w = p),
                  (D = this._repaintMajorText(p, s.getLabelMajor(), t, b))),
                (v = this._repaintMajorLine(p, _, t, b)))
              : f
              ? (v = this._repaintMinorLine(p, _, t, b))
              : v && (v.style.width = parseInt(v.style.width) + _ + 'px');
          }
          if (
            (1e3 !== x ||
              u ||
            ...
            var S = this.body.util.toTime(0),
              k = s.getLabelMajor(S),
              C = k.length * (this.props.majorCharWidth || 10) + 10;
            (void 0 == w || C < w) && this._repaintMajorText(0, k, t, b);
          }
        ...
        (o.prototype._repaintMinorText = function (t, e, i, o) {
          ...
          return (
            ...
            (n.innerHTML = e),
            (n.style.top =
              'top' == i ? this.props.majorLabelHeight + 'px' : '0'),
            this.options.rtl
        ...
        (o.prototype._repaintMajorText = function (t, e, i, o) {
          ...
          return (
            ...
            (n.style.top =
              'top' == i ? '0' : this.props.minorLabelHeight + 'px'),
            this.options.rtl
              ? ((n.style.left = ''), (n.style.right = t + 'px'))
              : (n.style.left = t + 'px'),
        ...
        (o.prototype._repaintMajorLine = function (t, e, i, o) {
          ...
          return (
            (n.style.top =
              'top' == i ? '0' : this.body.domProps.top.height + 'px'),
            this.options.rtl
              ? ((n.style.left = ''),
      ...
      (o.prototype = new r()),
        ...
        (o.prototype._onDrag = function (t) {
          if (this.eventParams.dragging) {
            var e =
                this.body.util.toScreen(this.eventParams.customTime) + t.deltaX,
            ...
            (0, c.default)(t, null, [
              {
                ...
                value: function (e, i, o) {
                  (f = !1), (g = i);
                  var n = i;
                  return void 0 !== o && (n = i[o]), t.parse(e, n, []), f;
                },
              },
              {
                key: 'parse',
              ...
              },
              {
                ...
                value: function (e, i, o, n) {
                  if (void 0 === o[e] && void 0 === o.__any__)
                    return void t.getSuggestion(e, o, n);
                  var s = e,
                    r = !0;
                  void 0 === o[e] &&
                    void 0 !== o.__any__ &&
                    ((s = '__any__'), (r = 'object' === t.getType(i[e])));
                  var a = o[s];
                  r && void 0 !== a.__type__ && (a = a.__type__),
                    t.checkFields(e, i, o, s, a, n);
                },
              },
              {
                key: 'checkFields',
                value: function (e, i, o, n, s, r) {
                  var a = function (i) {
                    ...
                    l = s[h];
                  void 0 !== l
                    ? 'array' === t.getType(l) && -1 === l.indexOf(i[e])
                      ? (a(
                  ...
                  (r =
                    void 0 !== n.indexMatch
                      ? ' in ' +
                        ...
                        n.indexMatch +
                        '"?\n\n'
                      : s.distance <= 4 && n.distance > s.distance
                      ? ' in ' +
                        t.printLocation(n.path, e, '') +
                ...
                value: function (e, i, o) {
                  ...
                  for (var l in i) {
                    ...
                    if (void 0 !== i[l].__type__ && !0 === n) {
                      ...
                      -1 !== l.toLowerCase().indexOf(h) && (d = l),
                        (u = t.levenshteinDistance(e, l)),
                        s > u && ((r = l), (a = m.copyArray(o)), (s = u));
                  }
                  return {
                    closestMatch: r,
                    path: a,
      ...
      (n.prototype = new m()),
        ...
        (n.prototype.setRange = function (t, e, i, o, n) {
          ...
          var s = this,
            ...
            h = void 0 != e ? p.convert(e, 'Date').valueOf() : null;
          if (
            ...
            return (function t() {
              if (!s.props.touch.dragging) {
                var e = new Date().valueOf(),
                  ...
                  g = u || null === h ? h : c + (h - c) * d;
                (_ = s._applyRange(p, g)),
                  f.updateHiddenDates(
                    s.options.moment,
                    s.body,
                    s.options.hiddenDates
                  ),
                  (b = b || _);
                var w = {
                ...
                if (
                  (n && n(d, _, u),
                  _ && s.body.emitter.emit('rangechange', w),
                  u)
                ) {
                  if (b && (s.body.emitter.emit('rangechanged', w), o))
                    return o();
        ...
        (n.prototype._applyRange = function (t, e) {
          ...
          if (null !== this.options.zoomMax) {
            ...
            h < 0 && (h = 0),
              n - o > h &&
                (this.end - this.start === h && o < this.start && n > this.end
                  ? ((o = this.start), (n = this.end))
                  : ((i = n - o - h), (o += i / 2), (n -= i / 2)));
          }
        ...
        (n.prototype._onDrag = function (t) {
          if (
            ...
            var a = this.props.touch.start + n,
              h = this.props.touch.end + n,
              d = f.snapAwayFromHidden(
                this.body.hiddenDates,
                a,
                this.previousDelta - i,
                !0
              ),
              l = f.snapAwayFromHidden(
                this.body.hiddenDates,
                h,
                this.previousDelta - i,
                !0
            ...
            if (d != a || l != h)
              return (
                ...
                (this.props.touch.start = d),
                (this.props.touch.end = l),
                void this._onDrag(t)
              );
        ...
        (n.prototype._onMouseWheel = function (t) {
          ...
          if (
            ...
            if (this.rolling)
              o =
                this.start +
                (this.end - this.start) * this.options.rollingMode.offset;
            else {
        ...
        (n.prototype._onPinch = function (t) {
          if (this.options.zoomable && this.options.moveable) {
            ...
            var h = f.snapAwayFromHidden(this.body.hiddenDates, r, 1 - e, !0),
              d = f.snapAwayFromHidden(this.body.hiddenDates, a, e - 1, !0);
            (h == r && d == a) ||
        ...
        (n.prototype._isInsideRange = function (t) {
          ...
          e = this.options.rtl
            ? i - p.getAbsoluteLeft(this.body.dom.centerContainer)
            : p.getAbsoluteRight(this.body.dom.centerContainer) - i;
        ...
        (n.prototype.zoom = function (t, e, i, o) {
          ...
          var n = f.getHiddenDurationBetween(
              this.body.hiddenDates,
              this.start,
              this.end
            ),
            s = f.getHiddenDurationBefore(
              this.options.moment,
              this.body.hiddenDates,
              this,
              e
          ...
          var d = f.snapAwayFromHidden(this.body.hiddenDates, a, i, !0),
            l = f.snapAwayFromHidden(this.body.hiddenDates, h, -i, !0);
          (d == a && l == h) || ((a = d), (h = l));
    ...
    function (t, e, i) {
      ...
      d(n.prototype),
        (n.prototype._create = function (t) {
          function e(t) {
            ...
            if (
              ...
              this.options.zoomKey && !t[this.options.zoomKey])
            )
              if (
                (t.preventDefault(),
                this.options.verticalScroll && Math.abs(i) >= Math.abs(e))
              ) {
          ...
          function o(t) {
            if (
              ...
              !(!t.target.className.indexOf('vis') > -1 || a))
            )
              return (t.dataTransfer.dropEffect = 'move'), (a = !0), !1;
          }
          function n(t) {
            t.preventDefault && t.preventDefault(),
            ...
            return (
              ...
              'item' !== e.target
                ...
                : s.itemSet._onDropObjectOnItem(t),
          ...
          (this.dom = {}),
            ...
            this.on(
              'rangechanged',
              function () {
                this.initialRangeChangeDone ||
                  (this.initialRangeChangeDone = !0);
              }.bind(this)
            ),
        ...
        (n.prototype.setOptions = function (t) {
          if (t) {
            ...
            if (
              ...
              'object' !== (0, h.default)(this.options.orientation) &&
              ...
              -1 !== o && this.components.splice(o, 1),
            ...
            if (
              ...
              'clickToUse' in t &&
                (t.clickToUse
                  ? this.activator || (this.activator = new m(this.dom.root))
                  : this.activator &&
        ...
        (n.prototype.setCustomTime = function (t, e) {
          ...
          if (0 === i.length)
            throw new Error(
              'No custom time bar found with id ' + (0, r.default)(e)
            );
        ...
        (n.prototype.getCustomTime = function (t) {
          ...
          if (0 === e.length)
            throw new Error(
              'No custom time bar found with id ' + (0, r.default)(t)
            );
        ...
        (n.prototype.addCustomTime = function (t, e) {
          ...
          if (
            this.customTimes.some(function (t) {
              return t.options.id === e;
            })
          )
            throw new Error(
          ...
          return (
            this.customTimes.push(o), this.components.push(o), this._redraw(), e
          );
        }),
          ...
          if (o && o.container && 0 != o.root.offsetWidth) {
            ...
            (i.centerContainer.height = r),
              ...
              e.verticalScroll
                ? e.rtl
                  ? ((i.left.width =
                      o.leftContainer.clientWidth || -i.border.left),
                    (i.right.width =
                      o.rightContainer.clientWidth + i.scrollbarWidth ||
                      -i.border.right))
                  : ((i.left.width =
                      o.leftContainer.clientWidth + i.scrollbarWidth ||
                      -i.border.left),
                    (i.right.width =
                      o.rightContainer.clientWidth || -i.border.right))
                : ((i.left.width =
                    o.leftContainer.clientWidth || -i.border.left),
                  (i.right.width =
                    o.rightContainer.clientWidth || -i.border.right)),
        ...
        (n.prototype._setDOM = function () {
          ...
          var i =
            t.root.width - t.left.width - t.right.width - t.borderRootWidth;
          (t.center.width = i),
    ...
    function (t, e, i) {
      ...
      (o.FORMAT = {
        ...
        (o.prototype.roundToMinor = function () {
          switch (
            ('week' == this.scale && this.current.weekday(0), this.scale)
          ) {
            case 'year':
              this.current.year(
        ...
        (o.prototype.setMinimumStep = function (t) {
          if (void 0 != t) {
            31104e9 > t && ((this.scale = 'year'), (this.step = 1e3)),
              15552e9 > t && ((this.scale = 'year'), (this.step = 500)),
              31104e8 > t && ((this.scale = 'year'), (this.step = 100)),
              15552e8 > t && ((this.scale = 'year'), (this.step = 50)),
              31104e7 > t && ((this.scale = 'year'), (this.step = 10)),
              15552e7 > t && ((this.scale = 'year'), (this.step = 5)),
              31104e6 > t && ((this.scale = 'year'), (this.step = 1)),
              7776e6 > t && ((this.scale = 'month'), (this.step = 3)),
              2592e6 > t && ((this.scale = 'month'), (this.step = 1)),
              432e6 > t && ((this.scale = 'day'), (this.step = 5)),
              1728e5 > t && ((this.scale = 'day'), (this.step = 2)),
              864e5 > t && ((this.scale = 'day'), (this.step = 1)),
              432e5 > t && ((this.scale = 'weekday'), (this.step = 1)),
              144e5 > t && ((this.scale = 'hour'), (this.step = 4)),
              36e5 > t && ((this.scale = 'hour'), (this.step = 1)),
              9e5 > t && ((this.scale = 'minute'), (this.step = 15)),
              6e5 > t && ((this.scale = 'minute'), (this.step = 10)),
              3e5 > t && ((this.scale = 'minute'), (this.step = 5)),
              6e4 > t && ((this.scale = 'minute'), (this.step = 1)),
              15e3 > t && ((this.scale = 'second'), (this.step = 15)),
              1e4 > t && ((this.scale = 'second'), (this.step = 10)),
              5e3 > t && ((this.scale = 'second'), (this.step = 5)),
              1e3 > t && ((this.scale = 'second'), (this.step = 1)),
          ...
          switch (this.scale) {
            ...
            case 'hour':
              h.push(
                'vis-h' +
                  r.hours() +
                  (4 == this.step ? '-h' + (r.hours() + 4) : '')
              ),
                h.push(e(r)),
                h.push(t(r.hours()));
              break;
            case 'weekday':
              h.push('vis-' + r.format('dddd').toLowerCase()),
                h.push(e(r)),
                h.push(i(r)),
                h.push(t(r.date()));
              break;
            case 'day':
              h.push('vis-day' + r.date()),
                h.push('vis-' + r.format('MMMM').toLowerCase()),
                h.push(e(r)),
                h.push(o(r)),
                h.push(this.step <= 2 ? e(r) : ''),
                h.push(
                  this.step <= 2 ? 'vis-' + r.format('dddd').toLowerCase() : ''
                ),
                h.push(t(r.date() - 1));
              break;
            case 'week':
              h.push('vis-week' + r.format('w')),
                h.push(i(r)),
                h.push(t(r.week()));
              break;
            case 'month':
    ...
    function (t, e, i) {
      function o(t, e, i) {
        if (
          ...
          if ('boolean' == typeof e.subgroupStack)
            ...
            for (var o in e.subgroupStack)
              (this.subgroupStack[o] = e.subgroupStack[o]),
                (this.doInnerStack = this.doInnerStack || e.subgroupStack[o]);
      ...
      (o.prototype._create = function () {
        ...
        (o.prototype.setData = function (t) {
          ...
          if (
            ...
            e instanceof Object
              ...
              : (this.dom.inner.innerHTML =
                  void 0 !== e && null !== e ? e : this.groupId || '');
          if (
            ((this.dom.label.title = (t && t.title) || ''),
            this.dom.inner.firstChild
              ? r.removeClassName(this.dom.inner, 'vis-hidden')
              : r.addClassName(this.dom.inner, 'vis-hidden'),
            t && t.nestedGroups)
          ) {
            (this.nestedGroups && this.nestedGroups == t.nestedGroups) ||
              ...
              (void 0 === t.showNested && void 0 !== this.showNested) ||
                (0 == t.showNested
                  ? (this.showNested = !1)
                  : (this.showNested = !0)),
              r.addClassName(this.dom.label, 'vis-nesting-group');
            var o = this.itemSet.options.rtl ? 'collapsed-rtl' : 'collapsed';
            this.showNested
              ? (r.removeClassName(this.dom.label, o),
                r.addClassName(this.dom.label, 'expanded'))
              : (r.removeClassName(this.dom.label, 'expanded'),
                r.addClassName(this.dom.label, o));
          } else
            this.nestedGroups &&
              ((this.nestedGroups = null),
              (o = this.itemSet.options.rtl ? 'collapsed-rtl' : 'collapsed'),
              r.removeClassName(this.dom.label, o),
              r.removeClassName(this.dom.label, 'expanded'),
              r.removeClassName(this.dom.label, 'vis-nesting-group'));
          t &&
            t.nestedInGroup &&
            (r.addClassName(this.dom.label, 'vis-nested-group'),
          ...
          n != this.className &&
            (this.className &&
              (r.removeClassName(this.dom.label, this.className),
              r.removeClassName(this.dom.foreground, this.className),
              r.removeClassName(this.dom.background, this.className),
              r.removeClassName(this.dom.axis, this.className)),
            r.addClassName(this.dom.label, n),
            r.addClassName(this.dom.foreground, n),
            r.addClassName(this.dom.background, n),
            r.addClassName(this.dom.axis, n),
            (this.className = n)),
            this.style &&
              (r.removeCssText(this.dom.label, this.style),
              (this.style = null)),
            t &&
              t.style &&
              (r.addCssText(this.dom.label, t.style), (this.style = t.style));
        }),
          ...
          if (t || this.stackDirty || (this.isVisible && !e)) {
            ...
            if ('function' == typeof this.itemSet.options.order) {
              var h = this,
                ...
                l = 0;
              if (
                (r.forEach(this.items, function (t, e) {
                  t.displayed ||
                    ((d[e] = t.redraw(!0)),
                    (l = d[e].length),
                    h.visibleItems.push(t));
                }),
                l > 0)
              )
                for (var u = 0; u < l; u++)
        ...
        (o.prototype._didResize = function (t, e) {
          ...
          var i = this.dom.inner.clientWidth,
            o = this.dom.inner.clientHeight;
          return (
            (t = r.updateProperty(this.props.label, 'width', i) || t),
            (t = r.updateProperty(this.props.label, 'height', o) || t)
          );
        }),
        (o.prototype._applyGroupHeight = function (t) {
          (this.dom.background.style.height = t + 'px'),
            (this.dom.foreground.style.height = t + 'px'),
            (this.dom.label.style.height = t + 'px');
        }),
        ...
        (o.prototype.redraw = function (t, e, i, o) {
          var n,
            ...
            a = [
              ...
              this._updateSubGroupHeights.bind(this, e),
        ...
        (o.prototype._updateSubGroupHeights = function (t) {
          if ((0, s.default)(this.subgroups).length > 0) {
            var e = this;
            this.resetSubgroups(),
              r.forEach(this.visibleItems, function (i) {
        ...
        (o.prototype._updateSubgroupsSizes = function () {
          ...
          if (t.subgroups)
            for (var e in t.subgroups) {
              var i =
                  t.subgroups[e].items[0].data.end ||
                  t.subgroups[e].items[0].data.start,
              ...
              t.subgroups[e].items.forEach(function (t) {
                ...
                (t.subgroups[e].start = o),
                (t.subgroups[e].end = new Date(n - 1));
            }
        }),
          ...
          if (void 0 !== this.subgroupOrderer) {
            ...
            if ('string' == typeof this.subgroupOrderer) {
              for (t in this.subgroups)
                e.push({
                  subgroup: t,
                  sortField: this.subgroups[t].items[0].data[
        ...
        (o.prototype.remove = function (t) {
          ...
          -1 != e && this.visibleItems.splice(e, 1),
            void 0 !== t.data.subgroup &&
        ...
        (o.prototype.order = function () {
          for (
            var t = r.toArray(this.items), e = [], i = [], o = 0;
            o < t.length;
            o++
          )
            void 0 !== t[o].data.end && i.push(t[o]), e.push(t[o]);
          (this.orderedItems = { byStart: e, byEnd: i }),
            a.orderByStart(this.orderedItems.byStart),
            a.orderByEnd(this.orderedItems.byEnd);
        }),
        (o.prototype._updateItemsInRange = function (t, e, i) {
          ...
          if (
            ...
            var p = r.binarySearchCustom(t.byEnd, d, 'data', 'end');
    ...
    function (t, e, i) {
      ...
      var n = i(43),
        ...
        r = i(51);
      (o.prototype = (0, s.default)(r.prototype)),
      ...
      (o.prototype = new n(null, null, null)),
        ...
        (o.prototype.repositionY = function () {
          ...
          e.style.top =
            'top' == t
              ? this.top + 'px'
              : this.parent.height - this.top - this.height + 'px';
        }),
    ...
    function (t, e, i) {
      ...
      (o.draw = function (t, e, i, o) {
        o = o || 0;
        for (var r = s(i, e), d = 0; d < t.length; d++)
          if (r) {
            var l = r(t[d], e);
            (!0 !== l &&
              'object' !== (void 0 === l ? 'undefined' : (0, a.default)(l))) ||
              h.drawPoint(
                t[d].screen_x + o,
                t[d].screen_y,
                n(e, l),
        ...
        (o.drawIcon = function (t, e, i, o, s, r) {
          ...
          d.setAttributeNS(null, 'x', e),
            d.setAttributeNS(null, 'y', i - a),
            d.setAttributeNS(null, 'width', o),
            d.setAttributeNS(null, 'height', 2 * a),
            d.setAttributeNS(null, 'class', 'vis-outline'),
            h.drawPoint(e + 0.5 * o, i, n(t), r.svgElements, r.svg);
        }),
        (t.exports = o);
    },
    function (t, e, i) {
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i, f, g, v, y) {
        ...
        var b,
          ...
          E = 'Array' == e ? C.entries || T : T;
        if (
          (E &&
            (w = u(E.call(new t()))) !== Object.prototype &&
            w.next &&
            (l(w, D, !0), o || a(w, p) || r(w, p, m)),
          S &&
            T &&
            'values' !== T.name &&
            ((k = !0),
          ...
          if (
            ...
            for (_ in b) _ in C || s(C, _, b[_]);
          else n(n.P + n.F * (c || k), e, b);
        return b;
      };
    },
    function (t, e, i) {
      t.exports =
        ...
        !i(19)(function () {
          return (
            7 !=
            Object.defineProperty(i(58)('div'), 'a', {
              get: function () {
                return 7;
              },
            }).a
    ...
    function (t, e, i) {
      var o = i(60),
        n = i(41).concat('length', 'prototype');
      e.f =
          ...
          (this.groupListeners = {
            add: function (t, e, o) {
              if (
                ...
                i.groupsData && i.groupsData.length > 0)
              ) {
                ...
                n.get().forEach(function (t) {
                  if (t.nestedGroups) {
                    ...
                    t.nestedGroups.forEach(function (i) {
                      var o = n.get(i);
                      o &&
                        ((o.nestedInGroup = t.id),
                        0 == t.showNested && (o.visible = !1),
                        (e = e.concat(o)));
                    }),
                      n.update(e, o);
                  }
      ...
      (n.prototype = new m()),
        ...
        (n.prototype.setSelection = function (t) {
          ...
          for (this.selection = [], e = 0, i = t.length; e < i; e++)
            (o = t[e]),
              (n = this.items[o]) && (this.selection.push(o), n.select());
        }),
        ...
        (n.prototype.getVisibleItems = function () {
          ...
          this.options.rtl
            ? ((t = this.body.util.toScreen(i.start)),
              (e = this.body.util.toScreen(i.end)))
            : ((e = this.body.util.toScreen(i.start)),
              (t = this.body.util.toScreen(i.end)));
          var o = [];
          for (var n in this.groups)
            if (this.groups.hasOwnProperty(n))
              for (
                ...
                var h = r[a];
                this.options.rtl
                  ? h.right < e && h.right + h.width > t && o.push(h.id)
                  : h.left < t && h.left + h.width > e && o.push(h.id);
              }
          return o;
        }),
        ...
        (n.prototype.redraw = function () {
          ...
          var b = {},
            _ = 0;
          if (
            (l.forEach(this.groups, function (t, i) {
              if (i !== D) {
                var o = t == m ? f : g;
                (b[i] = t.redraw(e, o, c, !0)), (_ = b[i].length);
              }
            }),
            _ > 0)
          ) {
        ...
        (n.prototype._updateUngrouped = function () {
          ...
          if (this.groupsData) {
            ...
            (i = new f(null, null, this)), (this.groups[x] = i);
            for (e in this.items)
        ...
        (n.prototype._getGroupId = function (t) {
          return 'background' == this._getType(t) && void 0 == t.group
            ? D
            : this.groupsData
            ? t.group
            : x;
        ...
        (n.prototype._onRemove = function (t) {
          ...
          t.forEach(function (t) {
            ...
            e &&
              (this._order(), this.body.emitter.emit('_change', { queue: !0 }));
        }),
        ...
        (n.prototype._onAddGroups = function (t) {
          ...
          t.forEach(function (t) {
            ...
            if (o) o.setData(i);
              ...
              if (t == x || t == D)
                throw new Error(
                  'Illegal group id. ' + t + ' is a reserved id.'
                );
        ...
        (n.prototype._onDragStartAddItem = function (t) {
          ...
          this.options.rtl
            ? ((e = l.getAbsoluteRight(this.dom.frame)),
              (i = e - t.center.x + 10))
            : ((e = l.getAbsoluteLeft(this.dom.frame)),
              (i = t.center.x - e - 10));
          var n = this.body.util.toTime(i),
          ...
          var m = { item: c, initialX: t.center.x, data: c.data };
          this.options.rtl ? (m.dragLeft = !0) : (m.dragRight = !0),
            (this.touchParams.itemProps = [m]),
            t.stopPropagation();
        }),
        (n.prototype._onDrag = function (t) {
          if (this.touchParams.itemProps) {
            ...
            var e,
              ...
              o = this.options.snap || null;
            e = this.options.rtl
              ? this.body.dom.root.offsetLeft + this.body.domProps.right.width
              : this.body.dom.root.offsetLeft + this.body.domProps.left.width;
            ...
            this.touchParams.itemProps.forEach(
              function (d) {
                var u,
                  ...
                  v = i.body.util.toTime(d.initialX - e);
                u = this.options.rtl ? -(g - v) : g - v;
                ...
                if (
                  ...
                  if (
                    ...
                    if (d.dragLeft)
                      this.options.rtl
                        ? void 0 != y.end &&
                          ((c = l.convert(d.data.end, 'Date')),
                          (f = new Date(c.valueOf() + u)),
                          (y.end = o ? o(f, n, s) : f))
                        : void 0 != y.start &&
                          ((p = l.convert(d.data.start, 'Date')),
                          (m = new Date(p.valueOf() + u)),
                          (y.start = o ? o(m, n, s) : m));
                    else if (d.dragRight)
                      this.options.rtl
                        ? void 0 != y.start &&
                      ...
                      if (
                        ((p = l.convert(d.data.start, 'Date').valueOf()),
                        (m = new Date(p + u)),
                        void 0 != y.end)
                      ) {
                        c = l.convert(d.data.end, 'Date');
                        var b = c.valueOf() - p.valueOf();
                        (y.start = o ? o(m, n, s) : m),
                          (y.end = new Date(y.start.valueOf() + b));
                      } else y.start = o ? o(m, n, s) : m;
                  if (
                    a &&
                    !d.dragLeft &&
                    !d.dragRight &&
                    ...
                    (_ = Math.max(0, _)),
                      (_ = Math.min(i.groupIds.length - 1, _)),
                      (y.group = i.groupIds[_]);
                  }
                  (y = this._cloneItemData(y)),
                    i.options.onMoving(
                      y,
                      function (t) {
        ...
        (n.prototype._onGroupClick = function (t) {
          ...
          if (e && e.nestedGroups) {
            var i = this.groupsData.getDataSet(),
              o = i.get(e.groupId);
            void 0 == o.showNested && (o.showNested = !0),
              (o.showNested = !o.showNested);
            var n = i.get(e.nestedGroups).map(function (t) {
              return (t.visible = o.showNested), t;
            });
            if ((i.update(n.concat(o)), o.showNested))
        ...
        (n.prototype._onGroupDrag = function (t) {
          if (this.options.groupEditable.order && this.groupTouchParams.group) {
            ...
            if (i && i != this.groupTouchParams.group) {
              ...
              h &&
                a &&
                (this.options.groupOrderSwap(h, a, e),
                e.update(h),
                e.update(a));
              var d = e.getIds({ order: this.options.groupOrder });
              if (!l.equalArray(d, this.groupTouchParams.originalOrder))
                for (
                  var u = this.groupTouchParams.originalOrder,
                    c = this.groupTouchParams.group.groupId,
                    m = Math.min(u.length, d.length),
                    f = 0,
                    g = 0,
                    v = 0;
                  f < m;
                  ...
                  if (d[f + g] == c) g = 1;
                    ...
                    var y = d.indexOf(u[f + v]),
                      b = e.get(d[f + g]),
                      _ = e.get(u[f + v]);
                    this.options.groupOrderSwap(b, _, e),
                      e.update(b),
                      e.update(_);
                    var w = d[f + g];
                    (d[f + g] = u[f + v]), (d[y] = w), f++;
            ...
            if (e !== this.itemFromRelatedTarget(t)) {
              ...
              if (this.options.showTooltips && i) {
                ...
                this.popup.setPosition(
                  t.clientX - l.getAbsoluteLeft(o) + o.offsetLeft,
                  t.clientY - l.getAbsoluteTop(o) + o.offsetTop
                ),
                  this.popup.show();
        ...
        (n.prototype._onMouseMove = function (t) {
          if (
            ...
            this.popup.setPosition(
              t.clientX - l.getAbsoluteLeft(e) + e.offsetLeft,
              t.clientY - l.getAbsoluteTop(e) + e.offsetTop
            ),
              this.popup.show();
          }
        }),
        ...
        (n.prototype._onAddItem = function (t) {
          if (this.options.selectable && this.options.editable.add) {
            ...
            this.options.rtl
              ? ((e = l.getAbsoluteRight(this.dom.frame)), (i = e - t.center.x))
              : ((e = l.getAbsoluteLeft(this.dom.frame)), (i = t.center.x - e));
            var s,
              r,
            ...
            'drop' == t.type
              ? ((r = JSON.parse(t.dataTransfer.getData('text'))),
                ...
                (r.start = r.start ? r.start : n ? n(a, h, d) : a),
                (r.type = r.type || 'box'),
                (r[this.itemsData._fieldId] = r.id || l.randomUUID()),
                'range' != r.type ||
                  r.end ||
                  ((s = this.body.util.toTime(i + this.props.width / 5)),
                  (r.end = n ? n(s, h, d) : s)))
              : ((r = { start: n ? n(a, h, d) : a, content: 'new item' }),
            ...
            u && (r.group = u.groupId),
              ...
              this.options.onAdd(r, function (e) {
                e &&
                  (o.itemsData.getDataSet().add(e),
                  'drop' == t.type && o.setSelection([e.id]));
              });
          }
        }),
        (n.prototype._onMultiSelectItem = function (t) {
          if (this.options.selectable) {
            ...
            if (e) {
              ...
              if (
                ((t.srcEvent && t.srcEvent.shiftKey) || !1) &&
                ...
                this.options.multiselectPerGroup &&
                  i.length > 0 &&
                  (s = this.itemsData.get(i[0]).group),
                  (this.options.multiselectPerGroup && void 0 != s && s != o) ||
                    i.push(e.id);
                var r = n._getItemRange(
                ...
                if (!this.options.multiselectPerGroup || s == o) {
                  ...
                  for (var a in this.items)
                    if (this.items.hasOwnProperty(a)) {
                      var h = this.items[a],
                        d = h.data.start,
                        l = void 0 !== h.data.end ? h.data.end : d;
                      !(d >= r.min && l <= r.max) ||
                        (this.options.multiselectPerGroup &&
                          s != this.itemsData.get(h.id).group) ||
                        h instanceof _ ||
                        i.push(h.id);
                    }
                }
              ...
              do {
                for (var a = null, h = 0, d = t.length; h < d; h++) {
                  ...
                  if (
                    null !== l.top &&
                    l !== r &&
                    e.collision(r, l, i.item, l.options.rtl)
                  ) {
                    a = l;
                    break;
                  }
                ...
                null != a && (r.top = a.top + a.height + i.item.vertical),
                  r.top + r.height > s && (s = r.top + r.height);
              } while (a);
            }
          }
          o.height = s - o.top + 0.5 * i.item.vertical;
        }),
          ...
          for (var a = 0; a < s.length; a++)
            if (((r = s[a]), o.hasOwnProperty(r))) {
              ...
              for (var d = t[r], l = 0; l < d.length; l++)
                void 0 !== d[l].data.subgroup &&
                  ((d[l].top =
                    o[d[l].data.subgroup].top + 0.5 * i.item.vertical),
                  o[r].stack && (d[l].baseTop = d[l].top));
              n && o[r].stack && e.substack(t[r], i, o[r]);
            }
        }),
        (e.collision = function (t, e, i, o) {
          return o
            ? t.right - i.horizontal + 0.001 < e.right + e.width &&
                t.right + t.width + i.horizontal - 0.001 > e.right &&
                t.top - i.vertical + 0.001 < e.top + e.height &&
                t.top + t.height + i.vertical - 0.001 > e.top
            : t.left - i.horizontal + 0.001 < e.left + e.width &&
                t.left + t.width + i.horizontal - 0.001 > e.left &&
                t.top - i.vertical + 0.001 < e.top + e.height &&
                t.top + t.height + i.vertical - 0.001 > e.top;
        }),
        ...
        (o.prototype.isVisible = function (t) {
          ...
          return 'right' == e
            ? this.data.start.getTime() > t.start &&
                this.data.start.getTime() - i < t.end
            : 'left' == e
            ? this.data.start.getTime() + i > t.start &&
              this.data.start.getTime() < t.end
            : this.data.start.getTime() + i / 2 > t.start &&
              this.data.start.getTime() - i / 2 < t.end;
        }),
        (o.prototype._createDomElement = function () {
          this.dom ||
            ((this.dom = {}),
          ...
          if (this.dirty) {
            ...
            var t = this.editable.updateTime || this.editable.updateGroup,
              e =
                ...
                (this.selected ? ' vis-selected' : '') +
                (t ? ' vis-editable' : ' vis-readonly');
            (this.dom.box.className = 'vis-item vis-box' + e),
              (this.dom.line.className = 'vis-item vis-line' + e),
              (this.dom.dot.className = 'vis-item vis-dot' + e);
          }
        }),
        (o.prototype._getDomComponentsSizes = function () {
          return {
    ...
    function (t, e, i) {
      ...
      (o.prototype = new n(null, null, null)),
        (o.prototype.isVisible = function (t) {
          ...
          return (
            this.data.start.getTime() + e > t.start && this.data.start < t.end
          );
        }),
        (o.prototype._createDomElement = function () {
          this.dom ||
          ...
          if (this.dirty) {
            ...
            var t = this.editable.updateTime || this.editable.updateGroup,
              e =
                ...
                (this.selected ? ' vis-selected' : '') +
                (t ? ' vis-editable' : ' vis-readonly');
            (this.dom.point.className = 'vis-item vis-point' + e),
              (this.dom.dot.className = 'vis-item vis-dot' + e);
          }
        }),
        (o.prototype._getDomComponentsSizes = function () {
        ...
        (o.prototype._updateDomComponentsSizes = function (t) {
          (this.props.dot.width = t.dot.width),
            ...
            this.options.rtl
              ? (this.dom.content.style.marginRight =
                  2 * this.props.dot.width + 'px')
              : (this.dom.content.style.marginLeft =
                  2 * this.props.dot.width + 'px'),
            (this.width = t.point.width),
            (this.height = t.point.height),
            (this.dom.dot.style.top =
              (this.height - this.props.dot.height) / 2 + 'px'),
            this.options.rtl
    ...
    function (t, e, i) {
      function o(t, e, i) {
        if (
          ((this.props = { content: { width: 0 } }), (this.overflow = !1), t)
        ) {
          if (void 0 == t.start)
            throw new Error('Property "start" missing in item ' + t.id);
          if (void 0 == t.end)
    ...
    function (t, e, i) {
      ...
      var o = 'string',
        ...
        a = {
          ...
          rollingMode: {
            follow: { boolean: n },
            offset: { number: s, undefined: 'undefined' },
            __type__: { object: r },
          },
            ...
            (0, u.default)(t, [
                ...
                value: function (t) {
                  if (void 0 !== t) {
                    ...
                    'string' == typeof t
                      ...
                      : 'function' == typeof t &&
                        ((this.options.filter = t), (e = !0)),
                      !1 === this.options.filter && (e = !1),
              ...
              },
              {
                ...
                value: function (t, e, i) {
                  ...
                  if (void 0 !== e) {
                    e < 0 && 1.2 * e < n
                      ? ((a.min = Math.ceil(1.2 * e)),
                        (d = a.min),
                        (h = 'range increased'))
                      : e / 1.2 < n &&
                        ((a.min = Math.ceil(e / 1.2)),
                        (d = a.min),
                        (h = 'range increased')),
                      1.2 * e > s &&
                        1 !== s &&
                        ((a.max = Math.ceil(1.2 * e)),
                        (d = a.max),
                        (h = 'range increased')),
                      (a.value = e);
                  } else a.value = o;
                  ...
                  var p = this._makeLabel(i[i.length - 1], i),
                    c = this._makeItem(i, p, a, l);
                  '' !== h &&
                    this.popupHistory[c] !== d &&
                    ((this.popupHistory[c] = d), this._setupPopup(h, c));
                },
              },
              {
                key: '_setupPopup',
        ...
        (this.itemsData = null),
          ...
          this.body.emitter.on('rangechanged', function () {
            (i.lastStart = i.body.range.start),
              (i.svg.style.left = r.option.asSize(-i.props.width)),
      ...
      (o.prototype = new l()),
        (o.prototype._create = function () {
          ...
          (t.className = 'vis-line-graph'),
            ...
            (this.legendLeft = new c(
              this.body,
              this.options.legend,
              'left',
              this.options.groups
            )),
            (this.legendRight = new c(
              this.body,
              this.options.legend,
              'right',
              this.options.groups
        ...
        (o.prototype.setOptions = function (t) {
          if (t) {
            ...
            void 0 === t.graphHeight && void 0 !== t.height
              ...
              r.mergeOptions(this.options, t, 'interpolation'),
              r.mergeOptions(this.options, t, 'drawPoints'),
              r.mergeOptions(this.options, t, 'shaded'),
              r.mergeOptions(this.options, t, 'legend'),
              t.interpolation &&
                'object' == (0, s.default)(t.interpolation) &&
              ...
              this.groups.hasOwnProperty('__ungrouped__') &&
                this.groups.__ungrouped__.setOptions(t);
          }
          this.dom.frame &&
            ((this.forceGraphUpdate = !0),
            this.body.emitter.emit('_change', { queue: !0 }));
        ...
        (o.prototype._updateAllGroupData = function (t, e) {
          if (null != this.itemsData) {
            ...
            for (var a = {}, h = 0; h < o.length; h++) {
              var d = o[h],
                l = d.group;
              (null !== l && void 0 !== l) || (l = '__ungrouped__'),
                a.hasOwnProperty(l) ? a[l]++ : (a[l] = 1);
            }
            var u = {};
            if (!e && t)
              for (l in this.groups)
                if (this.groups.hasOwnProperty(l)) {
                  g = this.groups[l];
                  var p = g.getItems();
                  i[l] = p.filter(function (t) {
                    return (u[t[n]] = t[n]), t[n] !== s[t[n]];
                  });
                  var c = a[l];
                  (a[l] -= i[l].length), i[l].length < c && (i[l][c - 1] = {});
                }
            for (h = 0; h < o.length; h++)
              if (
                ...
                var m = r.bridgeObject(d);
                (m.x = r.convert(d.x, 'Date')),
                  (m.end = r.convert(d.end, 'Date')),
                  (m.orginalY = d.y),
                  (m.y = Number(d.y)),
                  (m[n] = d[n]);
                var f = i[l].length - a[l]--;
                i[l][f] = m;
              }
            for (l in this.groups)
            ...
            for (l in i)
              if (i.hasOwnProperty(l))
                if (0 == i[l].length)
                  ...
                  var g = void 0;
                  void 0 != this.groupsData && (g = this.groupsData.get(l)),
                    void 0 == g &&
                      (g = { id: l, content: this.options.defaultGroup + l }),
                    this._updateGroup(g, l),
        ...
        (o.prototype.redraw = function () {
          ...
          if (
            ...
            1 == t &&
              ((this.svg.style.width = r.option.asSize(3 * this.props.width)),
              (this.svg.style.left = r.option.asSize(-this.props.width)),
              (-1 == (this.options.height + '').indexOf('%') &&
        ...
        (o.prototype._updateGraph = function () {
          if (
            ...
            var t,
              ...
              s = this._getSortedGroupIds();
            if (s.length > 0) {
              var r = {};
              for (
                this._getRelevantData(s, r, o, n),
                  this._applySampling(s, r),
                  e = 0;
                e < s.length;
                e++
              )
                this._convertXcoordinates(r[s[e]]);
              if ((this._getYRanges(s, r, i), 1 == this._updateYAxis(s, i)))
                return (
                  a.cleanupElements(this.svgElements),
                ...
                (t = this.groups[s[e]]),
                  !0 === this.options.stack &&
                    ...
                    ((void 0 != t.options.excludeFromStacking &&
                      ...
                      (void 0 != h &&
                        (this._stack(r[t.id], r[h.id]),
                        1 == t.options.shaded.enabled &&
                          'group' !== t.options.shaded.orientation &&
                          ('top' == t.options.shaded.orientation &&
                          'group' !== h.options.shaded.orientation
                            ? ((h.options.shaded.orientation = 'group'),
                              (h.options.shaded.groupId = t.id))
                            : ((t.options.shaded.orientation = 'group'),
                              (t.options.shaded.groupId = h.id)))),
                      (h = t))),
                  this._convertYcoordinates(r[s[e]], t);
              var d = {};
              for (e = 0; e < s.length; e++)
                if (
                  ((t = this.groups[s[e]]),
                  ...
                  if (
                    (d.hasOwnProperty(s[e]) || (d[s[e]] = f.calcPath(l, t)),
                    'group' === t.options.shaded.orientation)
                  ) {
                    var u = t.options.shaded.groupId;
                    if (-1 === s.indexOf(u)) {
                      console.log(
                        t.id + ': Unknown shading group target given:' + u
                      );
                      continue;
                    }
                    d.hasOwnProperty(u) ||
                      (d[u] = f.calcPath(r[u], this.groups[u])),
                      f.drawShading(d[s[e]], t, d[u], this.framework);
                  } else f.drawShading(d[s[e]], t, void 0, this.framework);
                }
              for (m.draw(s, r, this.framework), e = 0; e < s.length; e++)
                if (((t = this.groups[s[e]]), r[s[e]].length > 0))
                  switch (t.options.style) {
                    case 'line':
                      d.hasOwnProperty(s[e]) ||
                        (d[s[e]] = f.calcPath(r[s[e]], t)),
                        f.draw(d[s[e]], t, this.framework);
                    case 'point':
                    case 'points':
                      ('point' != t.options.style &&
                        'points' != t.options.style &&
                        1 != t.options.drawPoints.enabled) ||
                        g.draw(r[s[e]], t, this.framework);
                  }
            }
          }
          ...
          for (var a = 0; a < t.length; a++) {
            ...
            void 0 === r && ((s = e[e.length - 1]), (r = e[e.length - 1])),
              ...
              (t[a].y =
                0 == o
                  ? t[a].orginalY + r.y
                  : t[a].orginalY + (n / o) * (t[a].x - s.x) + s.y);
          }
        }),
            ...
            for (s = 0; s < t.length; s++) {
              ...
              if (1 == n.options.sort) {
                var l = function (t, e) {
                  ...
                  p = Math.min(
                    d.length,
                    r.binarySearchValue(d, o, 'x', 'after', l) + 1
                  );
                p <= 0 && (p = d.length);
                var c = new Array(p - u);
                for (a = u; a < p; a++) (h = n.itemsData[a]), (c[a - u] = h);
                e[t[s]] = c;
        ...
        (o.prototype._updateYAxis = function (t, e) {
          ...
          (n = this._toggleAxisVisiblity(s, this.yAxisLeft) || n),
            ...
            0 == this.yAxisRight.master
              ? ((this.yAxisLeft.lineOffset =
                  1 == r ? this.yAxisRight.width : 0),
      ...
      (o.prototype = new h()),
        ...
        (o.prototype.setOptions = function (t) {
          if (t) {
            ...
            r.selectiveDeepExtend(i, this.options, t),
        ...
        (o.prototype._redrawGroupIcons = function () {
          ...
          for (var n = 0; n < o.length; n++) {
            var r = o[n];
            !0 !== this.groups[r].visible ||
              (void 0 !== this.linegraphOptions.visibility[r] &&
                !0 !== this.linegraphOptions.visibility[r]) ||
              (this.groups[r].getLegend(e, 15, this.framework, t, i),
              (i += 19));
          }
        ...
        (o.prototype.redraw = function () {
          ...
          for (var i in this.groups)
            this.groups.hasOwnProperty(i) &&
              (!0 !== this.groups[i].visible ||
                (void 0 !== this.linegraphOptions.visibility[i] &&
                  !0 !== this.linegraphOptions.visibility[i]) ||
                e++);
        ...
        (o.prototype._redrawLabels = function () {
          var t = this,
            e = !1;
          a.prepareElements(this.DOMelements.lines),
            a.prepareElements(this.DOMelements.labels);
          ...
          void 0 != o.min && ((this.range.start = o.min), (s = !1)),
            ...
            (this.maxLabelSize = 0),
            this.scale.getLines().forEach(function (e) {
              var o = e.y,
                n = e.major;
          ...
          void 0 !== this.options[i].title &&
            ...
            (r = this.props.titleCharHeight);
          var h =
            !0 === this.options.icons
              ? Math.max(this.options.iconWidth, r) +
                this.options.labelOffsetX +
                15
              : r + this.options.labelOffsetX + 15;
          return (
            this.maxLabelSize > this.width - h && !0 === this.options.visible
              ? ((this.width = this.maxLabelSize + h),
                (this.options.width = this.width + 'px'),
                a.cleanupElements(this.DOMelements.lines),
                a.cleanupElements(this.DOMelements.labels),
                this.redraw(),
                (e = !0))
              : this.maxLabelSize < this.width - h &&
                !0 === this.options.visible &&
                this.width > this.minWidth
              ? ((this.width = Math.max(this.minWidth, this.maxLabelSize + h)),
                (this.options.width = this.width + 'px'),
                a.cleanupElements(this.DOMelements.lines),
                a.cleanupElements(this.DOMelements.labels),
                this.redraw(),
        ...
        (o.prototype._redrawTitle = function (t) {
          if (
            (a.prepareElements(this.DOMelements.title),
            ...
            (e.className = 'vis-y-axis vis-title vis-' + t),
              ...
              void 0 !== this.options[t].title.style &&
                r.addCssText(e, this.options[t].title.style),
              'left' === t
    ...
    function (t, e, i) {
      function o(t, e, i, o, n, s) {
        ...
        if (
          ...
          var h = this,
            d = function (t) {
              var e =
                t - (t % (h.magnitudefactor * h.minorSteps[h.minorStepIdx]));
              return t % (h.magnitudefactor * h.minorSteps[h.minorStepIdx]) >
                h.magnitudefactor * h.minorSteps[h.minorStepIdx] * 0.5
      ...
      (o.prototype.setCharHeight = function (t) {
        ...
        (o.prototype.followScale = function (t) {
          ...
          for (
            var a = t.convertValue(0), h = t.getStep() * t.scale, d = !1, l = 0;
            !d && l++ < 5;
            ...
            if (this.zeroAlign) {
              var f = a - p;
              (this._end += f / this.scale), (this._start = this._end - u);
            } else
              this.autoScaleStart
                ? ((this._start -= m / this.scale),
                  (this._end = this._start + u))
                : ((this._start += c - m / this.scale),
                  (this._end = this._start + u));
    ...
    function (t, e, i) {
      function o(t, e, i, o) {
        ...
        (this.options = r.selectiveBridgeObject(n, i)),
      ...
      (o.prototype.setItems = function (t) {
        null != t
          ? ((this.itemsData = t),
            1 == this.options.sort &&
              r.insertSort(this.itemsData, function (t, e) {
                return t.x > e.x ? 1 : -1;
              }))
          : (this.itemsData = []);
      }),
    ...
    function (t, e, i) {
      ...
      (o.drawIcon = function (t, e, i, o, s, r) {
        ...
        if (
          ...
          n.drawPoint(e + 0.5 * d + m, i + a - p - 1, f, r.svgElements, r.svg),
            n.drawPoint(
              e + 1.5 * d + m + 2,
              i + a - c - 1,
              f,
            ...
            if (
              ...
              'bar' === d.options.style &&
                ...
                (void 0 === i.options.groups.visibility[t[l]] ||
                  !0 === i.options.groups.visibility[t[l]]))
            )
            ...
            for (
              ...
              if (void 0 === c[a])
                l + 1 < p.length && (r = Math.abs(p[l + 1].screen_x - a)),
                  (h = o._getSafeDrawData(r, d, f));
              else {
                var v = l + (c[a].amount - c[a].resolved);
                v < p.length && (r = Math.abs(p[v].screen_x - a)),
                  (h = o._getSafeDrawData(r, d, f)),
                  (c[a].resolved += 1),
                  !0 === d.options.stack && !0 !== d.options.excludeFromStacking
                    ? p[l].screen_y < d.zeroPosition
                      ...
                      : ((g = c[a].accumulatedPositive),
                        (c[a].accumulatedPositive +=
                          d.zeroPosition - p[l].screen_y))
                    : !0 === d.options.barChart.sideBySide &&
                      ((h.width = h.width / c[a].amount),
                      (h.offset +=
                        c[a].resolved * h.width -
                        0.5 * h.width * (c[a].amount + 1)));
              }
              var y = h.width,
                b = p[l].screen_x;
              if (
                ...
                !0 === d.options.drawPoints.enabled)
              ) {
                var _ = {
        ...
        (o._getDataIntersections = function (t, e) {
          for (var i, o = 0; o < e.length; o++)
            o + 1 < e.length &&
              ...
              o > 0 &&
                (i = Math.min(i, Math.abs(e[o - 1].screen_x - e[o].screen_x))),
              0 === i &&
      ...
      (o.calcPath = function (t, e) {
        ...
        (o.serializePath = function (t, e, i) {
          ...
          if (i)
            ...
            for (o = 1; o < t.length; o++) n += t[o][0] + ',' + t[o][1] + ' ';
          return n;
        }),
        (o._catmullRomUniform = function (t) {
          ...
          for (var h = t.length, d = 0; d < h - 1; d++)
            (e = 0 == d ? t[0] : t[d - 1]),
              (i = t[d]),
              (o = t[d + 1]),
              (n = d + 2 < h ? t[d + 2] : o),
        ...
        (o._catmullRom = function (t, e) {
          ...
          for (var D = t.length, S = 0; S < D - 1; S++)
            (o = 0 == S ? t[0] : t[S - 1]),
              ...
              (a = {
                screen_x:
                  (-b * o.screen_x + p * n.screen_x + _ * s.screen_x) * m,
                screen_y:
                  (-b * o.screen_y + p * n.screen_y + _ * s.screen_y) * m,
              }),
              (h = {
                screen_x:
                  (y * n.screen_x + c * s.screen_x - b * r.screen_x) * f,
                screen_y:
                  (y * n.screen_y + c * s.screen_y - b * r.screen_y) * f,
              }),
            ...
            for (i = 0; i < e.length; i++)
              (o = e[i]),
                1 != this.groups[o].visible ||
                  (void 0 !== this.linegraphOptions.visibility[o] &&
                    1 != this.linegraphOptions.visibility[o]) ||
                  (r += this.groups[o].content + '<br />');
            (this.dom.textArea.innerHTML = r),
          ...
          if (this.dom.frame.parentNode) {
            ...
            for (var d = 0; d < t.length; d++) {
              ...
              1 != this.groups[l].visible ||
                ...
                (this.groups[l].getLegend(n, r, this.framework, o, h),
                (h += r + this.options.iconSpacing));
            }
          }
        }),
        (t.exports = o);
      ...
      var o = i(6),
        ...
        W =
          ...
          d(function () {
            ...
            ? function (t, e, i) {
                var o = T(j, e);
                o && delete j[e], M(t, e, i), o && t !== j && M(j, e, o);
              }
            : M,
        V = function (t) {
          var e = (F[t] = x(E.prototype));
          return (e._k = t), e;
        },
        B =
          Y && 'symbol' == typeof E.iterator
            ? function (t) {
        ...
        q = function (t, e) {
          y(t);
          for (var i, o = g((e = b(e))), n = 0, s = o.length; s > n; )
            U(t, (i = o[n++]), e[i]);
          return t;
        },
        X = function (t, e) {
        ...
        Z = function (t) {
          ...
          return (
            !(this === j && n(F, t) && !n(H, t)) &&
            (!(e || !n(this, t) || !n(F, t) || (n(this, N) && this[N][t])) || e)
          );
        },
        K = function (t, e) {
          if (((t = b(t)), (e = _(e, !0)), t !== j || !n(F, e) || n(H, e))) {
            var i = T(t, e);
            return (
              !i || !n(F, e) || (n(t, N) && t[N][e]) || (i.enumerable = !0), i
            );
          }
        },
        J = function (t) {
      ...
      Y ||
        ((E = function () {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            e = function (i) {
              this === j && e.call(H, i),
                n(this, N) && n(this[N], t) && (this[N][t] = !1),
                W(this, t, w(1, i));
            };
        ...
        (i(46).f = Z),
        (i(63).f = $),
        s && !i(35) && a(j, 'propertyIsEnumerable', Z, !0),
        (m.f = function (t) {
          return V(c(t));
        })),
        r(r.G + r.W + r.F * !Y, { Symbol: E });
      for (
        ...
        c(Q[tt++]);
      for (var et = C(c.store), it = 0; et.length > it; ) f(et[it++]);
      r(r.S + r.F * !Y, 'Symbol', {
        for: function (t) {
          return n(L, (t += '')) ? L[t] : (L[t] = E(t));
        },
        keyFor: function (t) {
              ...
              stringify: function (t) {
                if (void 0 !== t && !B(t)) {
                  ...
                  return (
                    ...
                    (!i && v(e)) ||
                      (e = function (t, e) {
                        if ((i && (e = i.call(this, t, e)), !B(e))) return e;
                      }),
                    (o[1] = e),
                    I.apply(P, o)
                  );
        ...
        E.prototype[A] || i(14)(E.prototype, A, E.prototype.valueOf),
        u(E, 'Symbol'),
        u(Math, 'Math', !0),
        u(o.JSON, 'JSON', !0);
    },
        ...
        !(function (e, i) {
          ...
          function v(t) {
            g(this, t),
              ...
              !1 === Eo && ((Eo = !0), e.updateOffset(this), (Eo = !1));
          }
          function y(t) {
          ...
          function F(t) {
            var e,
              i,
              o = {};
            for (i in t) d(t, i) && (e = L(i)) && (o[e] = t[i]);
            return o;
          }
          function H(t, e) {
            Ho[t] = e;
          ...
          function j(t) {
            var e = [];
            for (var i in t) e.push({ unit: i, priority: Ho[i] });
            return (
              e.sort(function (t, e) {
          ...
          function V(t, e) {
            return t.isValid()
              ? ((e = B(e, t.localeData())), (Go[e] = Go[e] || W(e)), Go[e](t))
          ...
          function B(t, e) {
            ...
            var o = 5;
            for (Yo.lastIndex = 0; o >= 0 && Yo.test(t); )
          ...
          function it(t, i) {
            return function (o) {
              return null != o
                ? (nt(this, t, o), e.updateOffset(this, i), this)
                : ot(this, t);
            };
          }
          function ot(t, e) {
          ...
          function rt(t, e) {
            ...
            } else if (((t = L(t)), k(this[t]))) return this[t](e);
            return this;
          }
          function at(t, e) {
            return ((t % e) + e) % e;
          ...
          function dt(t, e) {
            return t
              ? i(this._months)
                ...
                : this._months[
                    (this._months.isFormat || _n).test(e)
                      ? 'format'
                      : 'standalone'
                  ][t.month()]
              : i(this._months)
          ...
          function lt(t, e) {
            return t
              ? i(this._monthsShort)
                ...
                : this._monthsShort[_n.test(e) ? 'format' : 'standalone'][
                    t.month()
                  ]
              : i(this._monthsShort)
              ? this._monthsShort
          ...
          function ut(t, e, i) {
            ...
            return i
              ? 'MMM' === e
                ? ((n = yn.call(this._shortMonthsParse, r)),
                  -1 !== n ? n : null)
                : ((n = yn.call(this._longMonthsParse, r)), -1 !== n ? n : null)
              : 'MMM' === e
              ? -1 !== (n = yn.call(this._shortMonthsParse, r))
                ? n
                : ((n = yn.call(this._longMonthsParse, r)), -1 !== n ? n : null)
              : -1 !== (n = yn.call(this._longMonthsParse, r))
              ? n
              : ((n = yn.call(this._shortMonthsParse, r)), -1 !== n ? n : null);
          }
          function pt(t, e, i) {
            var o, n, s;
            ...
            for (
              ...
              if (
                ...
                return o;
              if (i && 'MMM' === e && this._shortMonthsParse[o].test(t))
                return o;
          ...
          function mt(t) {
            return null != t
              ? (ct(this, t), e.updateOffset(this, !0), this)
              : ot(this, 'Month');
          }
          function ft() {
          ...
          function gt(t) {
            return this._monthsParseExact
              ? (d(this, '_monthsRegex') || yt.call(this),
                t ? this._monthsShortStrictRegex : this._monthsShortRegex)
              : (d(this, '_monthsShortRegex') || (this._monthsShortRegex = Dn),
          ...
          function vt(t) {
            return this._monthsParseExact
              ...
              : (d(this, '_monthsRegex') || (this._monthsRegex = Sn),
          ...
          function Rt(t, e, i) {
            ...
            return i
              ? 'dddd' === e
                ? ((n = yn.call(this._weekdaysParse, r)), -1 !== n ? n : null)
                : 'ddd' === e
                ? ((n = yn.call(this._shortWeekdaysParse, r)),
                  -1 !== n ? n : null)
                : ((n = yn.call(this._minWeekdaysParse, r)),
                  -1 !== n ? n : null)
              : 'dddd' === e
              ? -1 !== (n = yn.call(this._weekdaysParse, r))
                ? n
                : -1 !== (n = yn.call(this._shortWeekdaysParse, r))
                ? n
                : ((n = yn.call(this._minWeekdaysParse, r)),
                  -1 !== n ? n : null)
              : 'ddd' === e
              ? -1 !== (n = yn.call(this._shortWeekdaysParse, r))
                ...
                : ((n = yn.call(this._minWeekdaysParse, r)),
                  -1 !== n ? n : null)
              : -1 !== (n = yn.call(this._minWeekdaysParse, r))
              ? n
              : -1 !== (n = yn.call(this._weekdaysParse, r))
              ? n
              : ((n = yn.call(this._shortWeekdaysParse, r)),
          ...
          function Lt(t, e, i) {
            ...
            for (
              ...
              if (
                ...
                return o;
              if (i && 'ddd' === e && this._shortWeekdaysParse[o].test(t))
                return o;
              if (i && 'dd' === e && this._minWeekdaysParse[o].test(t))
                return o;
          ...
          function Yt(t) {
            return this._weekdaysParseExact
              ? (d(this, '_weekdaysRegex') || Wt.call(this),
                t ? this._weekdaysStrictRegex : this._weekdaysRegex)
              : (d(this, '_weekdaysRegex') || (this._weekdaysRegex = On),
          ...
          function zt(t) {
            return this._weekdaysParseExact
              ...
              : (d(this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = Pn),
            ...
            return (
              i &&
                ...
                ((e =
                  i[ln] < 0 || i[ln] > 11
                    ? ln
                    : i[un] < 1 || i[un] > ht(i[dn], i[ln])
                    ? un
                    : i[pn] < 0 ||
                      i[pn] > 24 ||
                      (24 === i[pn] &&
                        (0 !== i[cn] || 0 !== i[mn] || 0 !== i[fn]))
                    ? pn
                    : i[cn] < 0 || i[cn] > 59
                    ? cn
                    : i[mn] < 0 || i[mn] > 59
                    ...
                    ? fn
                    : -1),
                c(t)._overflowDayOfYear && (e < dn || e > un) && (e = un),
                c(t)._overflowWeeks && -1 === e && (e = gn),
                c(t)._overflowWeekday && -1 === e && (e = vn),
                (c(t).overflow = e)),
              t
            );
          }
          ...
          function ae(t) {
            ...
            if (!t._d) {
              for (
                o = re(t),
                  t._w && null == t._a[un] && null == t._a[ln] && he(t),
                  null != t._dayOfYear &&
                    ((n = se(t._a[dn], o[dn])),
                    (t._dayOfYear > Q(n) || 0 === t._dayOfYear) &&
                      (c(t)._overflowDayOfYear = !0),
                    (i = _t(n, 0, t._dayOfYear)),
                    (t._a[ln] = i.getUTCMonth()),
                    (t._a[un] = i.getUTCDate())),
                  e = 0;
                e < 3 && null == t._a[e];
                ++e
              )
              ...
              24 === t._a[pn] &&
                ...
                0 === t._a[mn] &&
                0 === t._a[fn] &&
                ((t._nextDay = !0), (t._a[pn] = 0)),
                (t._d = (t._useUTC ? _t : bt).apply(null, s)),
                null != t._tzm &&
                  t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm),
                t._nextDay && (t._a[pn] = 24),
                t._w &&
                  void 0 !== t._w.d &&
                  t._w.d !== t._d.getDay() &&
                  (c(t).weekdayMismatch = !0);
            }
          }
          function he(t) {
            var e, i, o, n, s, r, a, h;
            if (((e = t._w), null != e.GG || null != e.W || null != e.E))
              (s = 1),
                (r = 4),
                (i = se(e.GG, t._a[dn], Dt(ke(), 1, 4).year)),
                (o = se(e.W, 1)),
                ((n = se(e.E, 1)) < 1 || n > 7) && (h = !0);
            else {
              (s = t._locale._week.dow), (r = t._locale._week.doy);
              var d = Dt(ke(), s, r);
              (i = se(e.gg, t._a[dn], d.year)),
                (o = se(e.w, d.week)),
                null != e.d
                  ? ((n = e.d) < 0 || n > 6) && (h = !0)
                  : null != e.e
          ...
          function de(t) {
            ...
            if (h) {
              ...
              if (h[4]) {
                if (!Yn.exec(h[4])) return void (t._isValid = !1);
                r = 'Z';
              }
              (t._f = n + (s || '') + (r || '')), ve(t);
            } else t._isValid = !1;
          ...
          function ce(t, e, i) {
            if (t) {
              if (Tn.indexOf(t) !== new Date(e[0], e[1], e[2]).getDay())
                return (c(i).weekdayMismatch = !0), (i._isValid = !1), !1;
            }
            return !0;
          }
          function me(t, e, i) {
          ...
          function fe(t) {
            var e = Vn.exec(pe(t._i));
            if (e) {
              var i = le(e[4], e[3], e[2], e[5], e[6], e[7]);
              if (!ce(e[1], i, t)) return;
              (t._a = i),
          ...
          function ve(t) {
            ...
            if (t._f === e.RFC_2822) return void fe(t);
            (t._a = []), (c(t).empty = !0);
            var i,
              o,
              n,
              ...
              d = 0;
            for (
              n = B(t._f, t._locale).match(jo) || [], i = 0;
              i < n.length;
              i++
            )
              (s = n[i]),
                ...
                o &&
                  ...
                  r.length > 0 && c(t).unusedInput.push(r),
                  (a = a.slice(a.indexOf(o) + o.length)),
                  (d += o.length)),
                zo[s]
                  ? (o ? (c(t).empty = !1) : c(t).unusedTokens.push(s),
                    $(s, o, t))
                  : t._strict && !o && c(t).unusedTokens.push(s);
            (c(t).charsLeftOver = h - d),
              ...
              (t._a[pn] = ye(t._locale, t._a[pn], t._meridiem)),
              ae(t),
              ne(t);
          }
          function ye(t, e, i) {
          ...
          function be(t) {
            var e, i, o, n, s;
            if (0 === t._f.length)
              return (c(t).invalidFormat = !0), void (t._d = new Date(NaN));
            ...
            return (
              ...
              null === e || (void 0 === o && '' === e)
                ...
                : ('string' == typeof e && (t._i = e = t._locale.preparse(e)),
                  y(e)
                    ? new v(ne(e))
                    : (a(e) ? (t._d = e) : i(o) ? be(t) : o ? ve(t) : De(t),
                      m(t) || (t._d = null),
                      t))
            );
          }
          ...
          function Se(t, e, s, r, a) {
            ...
            return (
              ...
              ((o(t) && n(t)) || (i(t) && 0 === t.length)) && (t = void 0),
          ...
          function Oe(t) {
            for (var e in t)
              if (-1 === yn.call(Zn, e) || (null != t[e] && isNaN(t[e])))
                return !1;
          ...
          function Fe(t, i) {
            ...
            return i._isUTC
              ? ((o = i.clone()),
                (n =
                  (y(t) || a(t) ? t.valueOf() : ke(t).valueOf()) - o.valueOf()),
          ...
          function je(t, i, o) {
            ...
            if (null != t) {
              ...
              return (
                !this._isUTC && i && (n = He(this)),
                (this._offset = t),
                (this._isUTC = !0),
                null != n && this.add(n, 'm'),
                s !== t &&
                  (!i || this._changeInProgress
                    ? ei(this, Ke(t - s, 'm'), 1, !1)
          ...
          function Ue() {
            ...
            var t = {};
            if ((g(t, this), (t = xe(t)), t._a)) {
              var e = t._isUTC ? u(t._a) : ke(t._a);
          ...
          function Ke(t, e) {
            ...
            return (
              Ne(t)
                ...
                : 'object' == typeof s &&
                  ('from' in s || 'to' in s) &&
                  ((n = Qe(ke(s.from), ke(s.to))),
                  (s = {}),
                  (s.ms = n.milliseconds),
                  (s.M = n.months)),
              (o = new Ie(s)),
              Ne(t) && d(t, '_locale') && (o._locale = t._locale),
              o
            );
          }
          function Je(t, e) {
          ...
          function ei(t, i, o, n) {
            ...
            t.isValid() &&
              ((n = null == n || n),
              a && ct(t, ot(t, 'Month') + a * o),
              r && nt(t, 'Date', ot(t, 'Date') + r * o),
          ...
          function oi(t, i) {
            var o = t || ke(),
              ...
              r = i && (k(i[s]) ? i[s].call(this, o) : i[s]);
            return this.format(r || this.localeData().calendar(s, this, ke(o)));
          }
          function ni() {
            return new v(this);
          }
          ...
          function ui(t, e, i) {
            ...
            if (((o = Fe(t, this)), !o.isValid())) return NaN;
            switch (
              ((n = 6e4 * (o.utcOffset() - this.utcOffset())), (e = L(e)))
            ) {
              case 'year':
                s = pi(this, o) / 12;
                break;
          ...
          function vi(t, e) {
            return this.isValid() && ((y(t) && t.isValid()) || ke(t).isValid())
          ...
          function Ji(t, e, i) {
            if ((r(t) && ((e = t), (t = void 0)), (t = t || ''), null != e))
          ...
          Mo = Array.prototype.some
            ...
            : function (t) {
                for (
                  var e = Object(this), i = e.length >>> 0, o = 0;
                  o < i;
                  o++
                )
          ...
          (yn = Array.prototype.indexOf
            ...
            K(['MMM', 'MMMM'], function (t, e, i, o) {
              ...
              null != n ? (e[ln] = n) : (c(i).invalidMonth = t);
            });
          var _n = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
          ...
          var Cn = 'Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday'.split(
              '_'
            ),
          ...
          G('H', ['HH', 2], 0, 'hour'),
            ...
            K('Hmm', function (t, e, i) {
              var o = t.length - 2;
              (e[pn] = _(t.substr(0, o))), (e[cn] = _(t.substr(o)));
            }),
            K('Hmmss', function (t, e, i) {
              var o = t.length - 4,
                n = t.length - 2;
          ...
          G(0, ['gg', 2], 0, function () {
            ...
            U('GGGGG', Qo, qo),
            U('ggggg', Qo, qo),
            J(['gggg', 'ggggg', 'GGGG', 'GGGGG'], function (t, e, i, o) {
              e[o.substr(0, 2)] = _(t);
            }),
          ...
          for (ss = 'S'; ss.length <= 9; ss += 'S') K(ss, Vi);
          ...
          (as.add = Qn),
            ...
            (as.weekYear = Li),
            (as.isoWeekYear = Fi),
            (as.quarter = as.quarters = zi),
            (as.month = mt),
            (as.daysInMonth = ft),
            (as.week = as.weeks = Mt),
            (as.isoWeek = as.isoWeeks = Ot),
            (as.weeksInYear = ji),
            (as.isoWeeksInYear = Hi),
            (as.date = is),
            (as.day = as.days = Ft),
            (as.weekday = Ht),
            (as.isoWeekday = jt),
            (as.dayOfYear = Wi),
            (as.hour = as.hours = An),
            (as.minute = as.minutes = os),
            (as.second = as.seconds = ns),
            (as.millisecond = as.milliseconds = rs),
            (as.utcOffset = je),
            (as.utc = Ge),
            (as.local = ze),
            (as.parseZone = We),
            (as.hasAlignedHourOffset = Ve),
            (as.isDST = Be),
            (as.isLocal = qe),
            (as.isUtcOffset = Xe),
            (as.isUtc = Ze),
          ...
          (hs.calendar = O),
            ...
            (hs.week = kt),
            (hs.firstDayOfYear = Tt),
            (hs.firstDayOfWeek = Ct),
            (hs.weekdays = It),
            (hs.weekdaysMin = At),
            (hs.weekdaysShort = Nt),
            (hs.weekdaysParse = Lt),
            (hs.weekdaysRegex = Yt),
            (hs.weekdaysShortRegex = Gt),
            (hs.weekdaysMinRegex = zt),
            (hs.isPM = Xt),
            (hs.meridiem = Zt),
            Qt('en', {
          ...
          return (
            ...
            (e.weekdaysShort = io),
            (e.normalizeUnits = L),
            (e.relativeTimeRounding = xo),
            (e.relativeTimeThreshold = Do),
            (e.calendarFormat = ii),
            (e.prototype = as),
            e
          );
      ...
      (function (e) {
        ...
        function n(t, e, i) {
          var n = (e && i) || 0,
            s = e || [];
          t = t || {};
          var r = void 0 !== t.clockseq ? t.clockseq : f,
          ...
          (s[n++] = (u >>> 8) & 255),
            ...
            (s[n++] = (r >>> 8) | 128),
            (s[n++] = 255 & r);
          for (var p = t.node || m, c = 0; c < 6; c++) s[n + c] = p[c];
          return e || o(s);
        }
        function s(t, e, i) {
          var n = (e && i) || 0;
    ...
    function (t, e, i) {
      function o(t, e, i, n) {
        ...
        if (
          !(Array.isArray(i) || i instanceof d || i instanceof l) &&
          i instanceof Object
        ) {
          var s = n;
          (n = i), (i = s);
        ...
        if (
          ...
          (this.options = h.deepExtend({}, this.defaultOptions)),
          this._create(t),
          !n || (n && void 0 === n.rtl))
        ) {
          this.dom.root.style.visibility = 'hidden';
          for (var p, f = this.dom.root; !p && f; )
            (p = window.getComputedStyle(f, null).direction),
              (f = f.parentElement);
          this.options.rtl = p && 'rtl' == p.toLowerCase();
        } else this.options.rtl = n.rtl;
        (this.options.rollingMode = n && n.rollingMode),
          (this.options.onInitialDrawComplete = n && n.onInitialDrawComplete),
          (this.components = []),
          (this.body = {
            dom: this.dom,
            domProps: this.props,
          ...
          (this.range = new u(this.body, this.options)),
          this.components.push(this.range),
          (this.body.range = this.range),
          (this.timeAxis = new c(this.body, this.options)),
          (this.timeAxis2 = null),
          this.components.push(this.timeAxis),
          (this.currentTime = new m(this.body, this.options)),
          this.components.push(this.currentTime),
          (this.itemSet = new g(this.body, this.options)),
          ...
          this.on('changed', function () {
            if (null != this.itemsData && !this.options.rollingMode) {
              if (!r.initialFitDone)
                if (
                  ((r.initialFitDone = !0),
                  void 0 != r.options.start || void 0 != r.options.end)
                ) {
                  if (void 0 == r.options.start || void 0 == r.options.end)
                    var t = r.getItemRange();
              ...
              !r.initialDrawDone &&
                r.initialRangeChangeDone &&
                ((r.initialDrawDone = !0),
                (r.dom.root.style.visibility = 'visible'),
                r.options.onInitialDrawComplete &&
                  setTimeout(function () {
      ...
      function r(t, e) {
        ...
        return (
          l < d
            ? s + i <= s + h() + u &&
              (s += h() - t.itemSet.options.margin.item.vertical)
            : l + u > d + i
            ? (s += h() + u - i + t.itemSet.options.margin.item.vertical)
            : (r = !1),
          (s = Math.min(s, o - i)),
          { shouldScroll: r, scrollOffset: s, itemTop: l }
        );
      }
      var a = i(3),
        h = i(0),
      ...
      (o.prototype = new p()),
        ...
        (o.prototype.setOptions = function (t) {
          if (
            ...
            p.prototype.setOptions.call(this, t),
        ...
        (o.prototype.setItems = function (t) {
          var e;
          (e = t
            ? t instanceof d || t instanceof l
              ? t
              : new d(t, { type: { start: 'Date', end: 'Date' } })
            : null),
            (this.itemsData = e),
            ...
            if (
              ...
              var a = this,
                ...
                u = function (t, e, i) {
                  var o = r(a, h);
                  if (
                    (l || (l = o), l.itemTop != o.itemTop || l.shouldScroll)
                  ) {
                    l.itemTop != o.itemTop &&
                      o.shouldScroll &&
                      ((l = o), (d = -1 * a._getScrollTop()));
                    var n = d,
                      s = l.scrollOffset,
                      u = i ? s : n + (s - n) * t;
                ...
                p = function () {
                  ...
                  t.shouldScroll &&
                    t.itemTop != l.itemTop &&
                    (a._setScrollTop(-t.scrollOffset), a._redraw());
                },
                c = function () {
                  p(), setTimeout(p, 100);
                },
                ...
                g = !e || void 0 === e.animation || e.animation;
              g || (l = { shouldScroll: !1, scrollOffset: -1, itemTop: -1 }),
                this.range.setRange(
                  m - f / 2,
                  m + f / 2,
                  { animation: g },
        ...
        (o.prototype.fit = function (t, e) {
          ...
          1 === n.length && void 0 === n.get()[0].end
            ? ((i = this.getDataRange()),
              this.moveTo(i.min.valueOf(), { animation: o }, e))
            : ((i = this.getItemRange()),
              this.range.setRange(i.min, i.max, { animation: o }, e));
        }),
        (o.prototype.getItemRange = function () {
          ...
          if (null != e && null != i) {
            var a = i - e;
            a <= 0 && (a = 10);
            var d = a / this.props.center.width,
              l = {},
              u = 0;
            ...
            if (
              (h.forEach(
                ...
                function (t) {
                  var a,
                    ...
                    u = s(t);
                  this.options.rtl
                    ? ((a = l - (t.getWidthRight() + 10) * d),
                      (h = u + (t.getWidthLeft() + 10) * d))
                    : ((a = l - (t.getWidthLeft() + 10) * d),
                      (h = u + (t.getWidthRight() + 10) * d)),
                    a < e && ((e = a), (o = t)),
                    h > i && ((i = h), (r = t));
                }.bind(this)
              ),
              ...
              var c = o.getWidthLeft() + 10,
                ...
                f = this.props.center.width - c - m;
              f > 0 &&
                (this.options.rtl
                  ? ((e = n(o) - (m * a) / f), (i = s(r) + (c * a) / f))
                  : ((e = n(o) - (c * a) / f), (i = s(r) + (m * a) / f)));
            }
          }
          return {
            ...
            i &&
              i.forEach(function (i) {
                var o = h.convert(i.start, 'Date').valueOf(),
                  n = h
                    .convert(void 0 != i.end ? i.end : i.start, 'Date')
                    .valueOf();
                (null === t || o < t) && (t = o),
                  (null === e || n > e) && (e = n);
              }),
        ...
        (o.prototype.getEventProperties = function (t) {
          ...
          e = this.options.rtl
            ? h.getAbsoluteRight(this.dom.centerContainer) - i
            : i - h.getAbsoluteLeft(this.dom.centerContainer);
          var n = o - h.getAbsoluteTop(this.dom.centerContainer),
          ...
          return (
            null != s
              ...
              : null != a
              ? (g = 'custom-time')
              : h.hasParent(m, this.timeAxis.dom.foreground)
              ? (g = 'axis')
              : this.timeAxis2 && h.hasParent(m, this.timeAxis2.dom.foreground)
              ? (g = 'axis')
              : h.hasParent(m, this.itemSet.dom.labelSet)
              ? (g = 'group-label')
              : h.hasParent(m, this.currentTime.bar)
              ? (g = 'current-time')
              : h.hasParent(m, this.dom.center) && (g = 'background'),
            {
              event: t,
              item: s ? s.id : null,
        ...
        return function e(i, o) {
          ...
          return (
            ...
            i.on('hammer.input', function (e) {
              (!0 !== r.preventDefault && r.preventDefault !== e.pointerType) ||
                e.preventDefault(),
      ...
      !(function (n, s, r, a) {
        ...
        function S(t, e) {
          for (
            ...
            if (((i = ft[s]), (o = i ? i + n : e) in t)) return o;
            s++;
          }
          return a;
        }
        ...
        function M(t) {
          ...
          return new (e || (Ct ? z : Tt ? B : kt ? q : G))(t, O);
        }
        function O(t, e, i) {
        ...
        function E(t, e) {
          ...
          (e.overallVelocityX = d.x),
            ...
            (e.overallVelocity = bt(d.x) > bt(d.y) ? d.x : d.y),
            (e.scale = r ? Y(r.pointers, o) : 1),
            (e.rotation = r ? j(r.pointers, o) : 0),
        ...
        function I(t, e) {
          ...
          if (e.eventType != It && (h > Mt || r.velocity === a)) {
            var d = e.deltaX - r.deltaX,
              l = e.deltaY - r.deltaY,
              u = R(h, d, l);
            (o = u.x),
              (n = u.y),
              (i = bt(u.x) > bt(u.y) ? u.x : u.y),
              (s = L(d, l)),
              (t.lastInterval = e);
          } else
            (i = r.velocity),
        ...
        function V(t, e) {
          ...
          return (
            e & (Pt | It) && (i = D(i.concat(o), 'identifier', !0)), [i, o]
          );
        }
        function B() {
        ...
        function U(t, e) {
          ...
          for (n = 0; n < r.length; )
            o[r[n].identifier] && a.push(r[n]),
              e & (Pt | It) && delete o[r[n].identifier],
              n++;
        ...
        function lt(t, e) {
          return (
            (e = e || {}),
            (e.recognizers = f(e.recognizers, lt.defaults.preset)),
            new ut(t, e)
          );
        }
        function ut(t, e) {
          (this.options = mt({}, lt.defaults, e || {})),
        ...
        T.prototype = {
          ...
          destroy: function () {
            this.evEl && v(this.element, this.evEl, this.domHandler),
              ...
              this.evWin && v(C(this.element), this.evWin, this.domHandler);
          },
        };
        ...
        (Q.prototype = {
          ...
          recognize: function (t) {
            ...
            this.state & (fe | ge | 32) && (this.state = ue),
              (this.state = this.process(e)),
              this.state & (pe | ce | me | ge) && this.tryEmit(e);
          },
          process: function (t) {},
          ...
          p(nt, ot, {
            ...
            getTouchAction: function () {
              var t = this.options.direction,
                e = [];
              return t & Ht && e.push(de), t & jt && e.push(he), e;
            },
            ...
            attrTest: function (t) {
              return (
                ot.prototype.attrTest.call(this, t) &&
                (this.state & pe ||
          ...
          p(rt, Q, {
            ...
            process: function (t) {
              ...
              if (
                ((this._input = t), !o || !i || (t.eventType & (Pt | It) && !n))
              )
                this.reset();
              ...
              else if (t.eventType & Pt) return fe;
              return 32;
            },
            reset: function () {
            ...
            process: function (t) {
              ...
              if (o && n && i) {
                ...
                var s = !this.pTime || t.timeStamp - this.pTime < e.interval,
                  r =
                    !this.pCenter || F(this.pCenter, t.center) < e.posThreshold;
              ...
              for (var s = 0; s < o.length; )
                (i = o[s]),
                  2 === e.stopped || (n && i != n && !i.canRecognizeWith(n))
                    ? i.reset()
                    : i.recognize(t),
                  !n && i.state & (pe | ce | me) && (n = e.curRecognizer = i),
                  s++;
            }
          },
          get: function (t) {
    ...
    function (t, e, i) {
      var o = i(17);
      o(o.S + o.F * !i(9), 'Object', { defineProperty: i(8).f });
    },
    function (t, e, i) {
      function o(t) {
        return t && t.__esModule ? t : { default: t };
            ...
            (0, d.default)(t, [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if ('none' !== t) {
                    ...
                    if ((void 0 !== o && (t = o), !0 === p.isString(t))) {
                      if (!0 === p.isValidRGB(t)) {
                        var n = t
                          .substr(4)
                          .substr(0, t.length - 5)
              ...
              },
              {
                ...
                value: function () {
                  ...
                  !0 ===
                    (!(arguments.length > 0 && void 0 !== arguments[0]) ||
                      arguments[0]) &&
                    (this.previousColor = p.extend({}, this.color)),
                    !0 === this.applied &&
              ...
              },
              {
                ...
                value: function (t) {
                  !0 ===
                    (!(arguments.length > 1 && void 0 !== arguments[1]) ||
                      arguments[1]) && (this.initialColor = p.extend({}, t)),
                    (this.color = t);
                  var e = p.RGBToHSV(t.r, t.g, t.b),
                    i = 2 * Math.PI,
                    o = this.r * e.s,
                  ...
                  (this.colorPickerSelector.style.left =
                    n - 0.5 * this.colorPickerSelector.clientWidth + 'px'),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  c = c < 0 ? c + 1 : c;
                  var m = d / this.r,
                    f = p.RGBToHSV(this.color.r, this.color.g, this.color.b);
                  (f.h = c), (f.s = m);
                  var g = p.HSVToRGB(f.h, f.s, f.v);
                  (g.a = this.color.a),
                    (this.color = g),
                    (this.initialColorDiv.style.backgroundColor =
                      'rgba(' +
