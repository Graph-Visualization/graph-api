...
!(function (a, b, c) {
      ...
      for (
        document.documentElement.firstChild.appendChild(c),
          ...
          c.styleSheet.cssText =
            a + '{x-qsa:expression(document._qsa && document._qsa.push(this))}',
          window.scrollBy(0, 0),
  ...
  document.getElementsByClassName ||
    (document.getElementsByClassName = function (a) {
      return (
        (a = String(a).replace(/^|\s+/g, '.')), document.querySelectorAll(a)
      );
    }),
  Object.keys ||
  ...
  (function () {
    function a(b, c, d) {
      b.document;
      var e,
        f = b.currentStyle[c].match(/([\d\.]+)(%|cm|em|in|mm|pc|pt|)/) || [
          0,
          0,
          '',
        ],
      ...
      return (
        (d = d
          ? /%|em/.test(h) && b.parentElement
            ? a(b.parentElement, 'fontSize', null)
            : 16
          : d),
        (e =
          'fontSize' == c
      ...
      for (d in f)
        if (
          (Array.prototype.push.call(
            e,
            'styleFloat' == d ? 'float' : d.replace(/[A-Z]/, h)
          ),
          'width' == d)
        )
  ...
  (function (a, b) {
    ...
    function d(a, b) {
      for (
        ...
        if (A.flags.dimensions.match(j))
          ...
          b.themes.hasOwnProperty(j) && (c.theme = p(b.themes[j], null)),
            (l = !0);
          ...
          null == A.vars.cache.themeKeys &&
            (A.vars.cache.themeKeys = Object.keys(b.themes));
          var n =
            A.vars.cache.themeKeys[
              0 | (Math.random() * A.vars.cache.themeKeys.length)
            ];
    ...
    function e(a, b, c, d) {
      ...
      if (
        ...
        null != c.text &&
          ((g.text = c.text), 'object' === b.nodeName.toLowerCase()))
      ) {
      ...
      c.font &&
        ...
        'background' == a
          ? null == b.getAttribute('data-background-src') &&
            m(b, { 'data-background-src': n })
          : m(b, { 'data-src': n }),
        (c.theme = g),
        ...
        ('image' == a || 'fluid' == a) &&
          m(b, {
            alt: g.text
              ? (g.text.length > 16 ? g.text.substring(0, 16) + '…' : g.text) +
                ' [' +
                h +
                ']'
              : h,
          ...
          ? (('html' != o.renderer && c.auto) ||
            ...
            'html' == o.renderer
              ...
              : (f(a, { dimensions: e, theme: g, flags: c }, b, o),
                c.textmode &&
                  'exact' == c.textmode &&
                  (A.vars.resizableImages.push(b), i(b))))
    ...
    function f(a, b, c, d) {
      ...
      'background' == a
        ? ((c.style.backgroundImage = 'url(' + f + ')'),
          (c.style.backgroundSize = h.width + 'px ' + h.height + 'px'))
        : ('img' === c.nodeName.toLowerCase()
            ? m(c, { src: f })
            : 'object' === c.nodeName.toLowerCase() &&
              (m(c, { data: f }), m(c, { type: 'image/svg+xml' })),
          d.reRender &&
            setTimeout(function () {
              var a = e();
              ...
              'img' === c.nodeName.toLowerCase()
                ? m(c, { src: a })
                : 'object' === c.nodeName.toLowerCase() &&
                  (m(c, { data: a }), m(c, { type: 'image/svg+xml' }));
            }, 100)),
      ...
      switch (
        ((a.font = {
          ...
          size: h(
            a.width,
            a.height,
            a.theme.size ? a.theme.size : A.defaults.size
          ),
      ...
      if (g.lineCount > 1) {
        ...
        for (var o = 0; o < g.words.length; o++) {
          ...
          (k + p.width >= m || q === !0) &&
            ...
            (j.y = l)),
            q !== !0 &&
              (i.moveTo(k, 0), (k += g.spaceWidth + p.width), j.add(i));
        }
        b(f, j, k, f.properties.leading);
        ...
        (i = new d.Text(a.text)),
          ...
          f.add(j),
          f.moveTo(
            (a.width - g.boundingBox.width) / 2,
            (a.height - g.boundingBox.height) / 2,
            null
          );
      return c;
    }
        ...
        if (b.hasOwnProperty(c)) {
          ...
          if (d.holderData) {
            ...
            if (g) {
              ...
              e.textmode &&
                'exact' == e.textmode &&
                ((e.exactDimensions = g), (k.dimensions = e.dimensions)),
      ...
      if (a.holderData) {
        ...
        if (b) {
          ...
          d.fluidWidth && !d.fluidHeight
            ? ((d.mode = 'width'),
              (d.ratio =
                d.initialDimensions.width / parseFloat(c.dimensions.height)))
            : !d.fluidWidth &&
              d.fluidHeight &&
              ((d.mode = 'height'),
              (d.ratio =
                parseFloat(c.dimensions.width) / d.initialDimensions.height)),
    ...
    function o(a, c) {
      if (b.XMLSerializer) {
        ...
        if ((a.querySelector('defs'), c.svgXMLStylesheet)) {
          ...
          var j = g.createProcessingInstruction(
            'xml',
    ...
    var x = 'http://www.w3.org/2000/svg',
      ...
      z = {
        addTheme: function (a, b) {
          return (
            null != a && null != b && (A.settings.themes[a] = b),
        ...
        run: function (a) {
          ...
          (f.renderer = g.renderer ? g.renderer : A.setup.renderer),
            -1 === A.setup.renderers.join(',').indexOf(f.renderer) &&
              (f.renderer = A.setup.supportsSVG
                ? 'svg'
                : A.setup.supportsCanvas
                ? 'canvas'
                : 'html'),
          ...
          for (var m = 0; m < j.length; m++) {
            ...
            if (
              n.attributes.rel &&
              n.attributes.href &&
              'stylesheet' == n.attributes.rel.value
            ) {
      ...
      B = (function () {
        ...
        return function (d) {
          ...
          if (A.setup.supportsSVG) {
            ...
            var j = b.getBBox(),
              k = Math.ceil(
                j.width / (e.properties.width * A.setup.lineWrapRatio)
              ),
              o = i.text.split(' '),
              p = i.text.match(/\\n/g);
            (k += null == p ? 0 : p.length),
        ...
        return function (c) {
          ...
          (a.width = A.dpr(d.properties.width)),
            ...
            b.fillRect(
              0,
              0,
              A.dpr(d.children.holderBg.width),
              A.dpr(d.children.holderBg.height)
            );
          ...
          return (
            ...
            function (b, d) {
              ...
              var z =
                ...
                btoa(unescape(encodeURIComponent(o(a, d))));
              return z;
            }
          );
        }
    ...
    (A.setup = {
      ...
      (function () {
        ...
        d.getContext &&
          ...
          ((A.setup.renderer = 'canvas'),
          (e = d.getContext('2d')),
          (A.setup.supportsCanvas = !0)),
          A.setup.supportsCanvas &&
      ...
      b.onDomReady &&
        b.onDomReady(function () {
          A.vars.preempted || z.run(),
            b.addEventListener
              ? (b.addEventListener('resize', s, !1),
                b.addEventListener('orientationchange', s, !1))
   ...
   */ !(function (a) {
    ...
    var d,
      ...
      x = function (b) {
        ...
        return (
          h.length &&
            f.push('trustedOrigins=' + encodeURIComponent(h.join(','))),
          'string' == typeof b.jsModuleId &&
            b.jsModuleId &&
            f.push('jsModuleId=' + encodeURIComponent(b.jsModuleId)),
          f.join('&')
        );
      },
      y = function (a, b, c) {
        ...
        return (
          ...
          b ||
            ('number' == typeof N.zIndex && N.zIndex > 0
              ? (b = N.zIndex)
              : 'string' == typeof N.zIndex &&
                (c = parseInt(N.zIndex, 10)) &&
                !isNaN(c) &&
                c > 0 &&
                (b = c)),
          b || 0
      ...
      F = (function () {
        ...
        return function (c, d) {
          ...
          if (
            'string' == typeof f &&
            (e = f.toLowerCase()) &&
            /^always|samedomain|never$/.test(e)
          )
            return b[e];
          var g = E(d.moviePath);
          null === g && (g = c);
      ...
      K = function (a, b) {
        return this instanceof K
          ? ((this.id = '' + g++),
            ...
            a && this.clip(a),
            'undefined' != typeof b &&
              (C('new ZeroClipboard(elements, options)', N.debug), K.config(b)),
    ...
    (K.prototype.setText = function (a) {
      return (
        a &&
          '' !== a &&
          ((f['text/plain'] = a),
          e.ready === !0 && e.bridge && 'function' == typeof e.bridge.setText
            ? e.bridge.setText(a)
            : (e.ready = !1)),
        this
      );
    ...
    (K.config = function (a) {
      ...
      (K.destroy = function () {
        ...
        c &&
          c.parentNode &&
          (c.parentNode.removeChild(c), (e.ready = null), (e.bridge = null));
      }),
    ...
    var O = function () {
        ...
        if (!d) {
          var f = K.config();
          f.jsModuleId =
            ('string' == typeof k && k) || ('string' == typeof l && l) || null;
      ...
      P = function (a) {
        for (
          var b = /^OBJECT|EMBED$/, c = a && a.parentNode;
          c && b.test(c.nodeName) && c.parentNode;
    ...
    (K.prototype.on = function (a, b) {
      ...
      if (f && f.length) {
        ...
        g.noflash && e.disabled && T.call(this, 'noflash', {}),
          g.wrongflash &&
            e.outdated &&
            T.call(this, 'wrongflash', { flashVersion: e.version }),
          g.load &&
            e.ready &&
            T.call(this, 'load', { flashVersion: e.version });
      }
      return this;
    }),
    ...
    (K.prototype.clip = function (a) {
      ...
      for (var b = 0; b < a.length; b++)
        if (a.hasOwnProperty(b) && a[b] && 1 === a[b].nodeType) {
          a[b].zcClippingId
            ? -1 === y(this.id, j[a[b].zcClippingId]) &&
              j[a[b].zcClippingId].push(this.id)
          ...
          for (var e = a.length; e--; )
            if (a.hasOwnProperty(e) && a[e] && 1 === a[e].nodeType) {
              ...
              if (f) {
                ...
                0 === f.length &&
                  (N.autoActivate === !0 && r(a[e], 'mouseover', p),
    ...
    (N.hoverClass = 'zeroclipboard-is-hover'),
      ...
      (K.dispatch = function (a, b) {
        if ('string' == typeof a && a) {
          ...
          if (c)
            for (
              var e = d && N.autoActivate === !0 ? S(d) : M(),
                f = 0,
                g = e.length;
              g > f;
              f++
      ...
      (K.prototype.receiveEvent = function (a, b) {
        if (
          (C('ZeroClipboard.prototype.receiveEvent', N.debug),
          'string' == typeof a && a)
        ) {
          var c = a.toLowerCase().replace(/^on/, '');
          c && T.call(this, c, b);
      ...
      (K.prototype.setCurrent = function (a) {
        return (
          C('ZeroClipboard.prototype.setCurrent', N.debug), K.activate(a), this
        );
      }),
      (K.prototype.resetBridge = function () {
        return (
          C('ZeroClipboard.prototype.resetBridge', N.debug),
          K.deactivate(),
          this
        );
      }),
      (K.prototype.setTitle = function (a) {
        if (
          (C('ZeroClipboard.prototype.setTitle', N.debug),
      ...
      (K.prototype.addEventListener = function (a, b) {
        return (
          C('ZeroClipboard.prototype.addEventListener', N.debug), this.on(a, b)
        );
      }),
      (K.prototype.removeEventListener = function (a, b) {
        return (
          C('ZeroClipboard.prototype.removeEventListener', N.debug),
          this.off(a, b)
        );
      }),
