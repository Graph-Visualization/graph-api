...
!(function (e, t) {
  ...
  var t,
    ...
    f = function (e) {
      for (
        var t, n = String(e), o = n.length, r = -1, a = '', c = n.charCodeAt(0);
        ++r < o;
  ...
  r.animateScroll = function (t, n, r) {
    ...
    var L = function (o, r, c) {
        ...
        (o == r || u == r || e.innerHeight + u >= E) &&
          (clearInterval(c), l.focus(), a.callbackAfter(t, n));
      },
      Q = function () {
        (A += 16),
          (O = A / parseInt(a.speed, 10)),
          (O = O > 1 ? 1 : O),
          (y = g + H * d(a.easing, O)),
  ...
  var g = function (e) {
      ...
      n &&
        ...
        (e.preventDefault(), r.animateScroll(n, n.hash, t));
    },
    b = function () {
      n ||
  ...
  return (
    (r.destroy = function () {
      t &&
        ...
        e.removeEventListener('resize', b, !1),
        (t = null),
        (n = null),
        (o = null));
    }),
    (r.init = function (n) {
      a &&
        (r.destroy(),
        (t = i(c, n || {})),
        (o = document.querySelector('[data-scroll-header]')),
        document.addEventListener('click', g, !1),
        o && e.addEventListener('resize', b, !1));
    }),
    r
  );
});
